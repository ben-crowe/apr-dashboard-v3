...
5. **"49 custom fields" was the PROD list's set** (`901402094744`, Chris's prod — do NOT write). The test list has 27. Phase-2 assertion = 27 fields on the test list, not 49.
