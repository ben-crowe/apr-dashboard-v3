...
In selecting applicable approaches to value, the appraiser considered the agreed upon appraisal scope and assessed the applicability of each traditional approach given the subject's characteristics and the intended use of the appraisal. As a result, this appraisal developed Direct Comparison and Income (Direct Capitalization) Approaches. The values presented represent the As Stabilized (Fee Simple Estate).`,
  ...
  'exposure-visibility': 'Exposure of the subject is average noting frontage on 109 Street & 11 Avenue',
...
export const fieldToSectionMap: Record<string, string> = {
  ...
  // Calculator section
  'calc-type1-name': 'calc',
  'calc-type1-count': 'calc',
  'calc-type1-sf': 'calc',
  'calc-type1-rent': 'calc',
  'calc-type1-annual': 'calc',
  'calc-type2-name': 'calc',
  'calc-type2-count': 'calc',
  'calc-type2-sf': 'calc',
  'calc-type2-rent': 'calc',
  'calc-type2-annual': 'calc',
  'calc-type3-name': 'calc',
  'calc-type3-count': 'calc',
  'calc-type3-sf': 'calc',
  'calc-type3-rent': 'calc',
  'calc-type3-annual': 'calc',
  'calc-type4-name': 'calc',
  'calc-type4-count': 'calc',
  'calc-type4-sf': 'calc',
  'calc-type4-rent': 'calc',
  'calc-type4-annual': 'calc',
  'calc-total-units': 'calc',
  'calc-total-sf': 'calc',
  'calc-avg-unit-sf': 'calc',
  'calc-total-rental-revenue': 'calc',
  'calc-avg-rent-per-unit': 'calc',
  'calc-avg-rent-per-sf': 'calc',
  'calc-parking-per-unit': 'calc',
  'calc-parking-total': 'calc',
  'calc-laundry-per-unit': 'calc',
  'calc-laundry-total': 'calc',
  'calc-other-income': 'calc',
  'calc-total-other-income': 'calc',
  'calc-pgr': 'calc',
  'calc-vacancy-rate': 'calc',
  'calc-bad-debt-rate': 'calc',
  'calc-concessions-rate': 'calc',
  'calc-vacancy-loss': 'calc',
  'calc-egr': 'calc',
  ...
  'calc-exp-other': 'calc',
  'calc-expenses-total': 'calc',
  'calc-expense-ratio': 'calc',
  'calc-cap-rate': 'calc',
  'calc-adj-capex': 'calc',
  ...
  'calc-adj-total': 'calc',
  'calc-noi': 'calc',
  'calc-noi-per-unit': 'calc',
  'calc-noi-per-sf': 'calc',
  'calc-raw-value': 'calc',
  'calc-indicated-value': 'calc',
