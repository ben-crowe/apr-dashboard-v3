...
| [Conditional Field Logic — Complete Reference](~/Development/APR-Dashboard-v3/docs/valta share/CONDITIONAL-FIELD-LOGIC.md) | The authoritative cascade rule set — predefined fields that auto-fill on option combos. |
