...
export const fieldRegistry: FieldDefinition[] = [
  ...
  { id: 'client-phone', storeId: 'client-phone', label: 'Client Phone', section: 'client-intake', subsection: 'client-info-intake', type: 'text', inputSource: 'user-input', required: true },
  { id: 'client-title', storeId: 'client-title', label: 'Client Title', section: 'client-intake', subsection: 'client-info-intake', type: 'text', inputSource: 'user-input', required: false },
  { id: 'client-organization', storeId: 'client-organization', label: 'Organization', section: 'client-intake', subsection: 'client-info-intake', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'contact-phone', storeId: 'contact-phone', label: 'Contact Phone', section: 'client-intake', subsection: 'property-contact-intake', type: 'text', inputSource: 'user-input', required: false },
  { id: 'contact-full-name', storeId: 'contact-full-name', label: 'Contact Full Name', section: 'client-intake', subsection: 'property-contact-intake', type: 'text', inputSource: 'calculated', required: false, calculationFormula: 'contact-first-name + " " + contact-last-name' },
  ...
  { id: 'job-number', storeId: 'job-number', label: 'Valcre Job ID (VAL#)', section: 'loe-prep', subsection: 'job-assignment', type: 'text', inputSource: 'user-input', required: false },

  // Financial Terms Subsection
  { id: 'appraisal-fee', storeId: 'appraisal-fee', label: 'Appraisal Fee', section: 'loe-prep', subsection: 'financial-terms', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'retainer-amount', storeId: 'retainer-amount', label: 'Retainer Amount', section: 'loe-prep', subsection: 'financial-terms', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'payment-terms', storeId: 'payment-terms', label: 'Payment Terms', section: 'loe-prep', subsection: 'financial-terms', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'special-instructions', storeId: 'special-instructions', label: 'Special Instructions', section: 'loe-prep', subsection: 'scope-loe', type: 'textarea', inputSource: 'user-input', required: false },

  // Comments Subsection
  { id: 'internal-comments', storeId: 'internal-comments', label: 'Internal Comments', section: 'loe-prep', subsection: 'comments-loe', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'appraiser-comments', storeId: 'appraiser-comments', label: 'Appraiser Comments', section: 'loe-prep', subsection: 'comments-loe', type: 'textarea', inputSource: 'user-input', required: false },

  // Appraiser Info Subsection
  { id: 'appraiser-name', storeId: 'appraiser-name', label: 'Appraiser Name', section: 'loe-prep', subsection: 'appraiser-info', type: 'text', inputSource: 'user-input', required: true },
  { id: 'appraiser-credentials', storeId: 'appraiser-credentials', label: 'Appraiser Credentials', section: 'loe-prep', subsection: 'appraiser-info', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'zoning-map-title', storeId: 'zoning-map-title', label: 'Zoning Map Title', section: 'image-mgt', subsection: 'maps', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'site-plan-1-title', storeId: 'site-plan-1-title', label: 'Site Plan 1 Title', section: 'image-mgt', subsection: 'maps', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'site-plan-2-title', storeId: 'site-plan-2-title', label: 'Site Plan 2 Title', section: 'image-mgt', subsection: 'maps', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-2-caption', storeId: 'subject-photo-2-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-3-caption', storeId: 'subject-photo-3-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-4-caption', storeId: 'subject-photo-4-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-5-caption', storeId: 'subject-photo-5-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-6-caption', storeId: 'subject-photo-6-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-7-caption', storeId: 'subject-photo-7-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-8-caption', storeId: 'subject-photo-8-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-9-caption', storeId: 'subject-photo-9-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-10-caption', storeId: 'subject-photo-10-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-11-caption', storeId: 'subject-photo-11-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-12-caption', storeId: 'subject-photo-12-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-13-caption', storeId: 'subject-photo-13-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-14-caption', storeId: 'subject-photo-14-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-15-caption', storeId: 'subject-photo-15-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-16-caption', storeId: 'subject-photo-16-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-17-caption', storeId: 'subject-photo-17-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-18-caption', storeId: 'subject-photo-18-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-19-caption', storeId: 'subject-photo-19-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-20-caption', storeId: 'subject-photo-20-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-21-caption', storeId: 'subject-photo-21-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-22-caption', storeId: 'subject-photo-22-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-23-caption', storeId: 'subject-photo-23-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-24-caption', storeId: 'subject-photo-24-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-25-caption', storeId: 'subject-photo-25-caption', label: 'Caption', section: 'image-mgt', subsection: 'subject-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp1-photo-caption', storeId: 'comp1-photo-caption', label: 'Caption', section: 'image-mgt', subsection: 'comp-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp2-photo-caption', storeId: 'comp2-photo-caption', label: 'Caption', section: 'image-mgt', subsection: 'comp-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp3-photo-caption', storeId: 'comp3-photo-caption', label: 'Caption', section: 'image-mgt', subsection: 'comp-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp4-photo-caption', storeId: 'comp4-photo-caption', label: 'Caption', section: 'image-mgt', subsection: 'comp-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp5-photo-caption', storeId: 'comp5-photo-caption', label: 'Caption', section: 'image-mgt', subsection: 'comp-photos', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'exp-taxes-comment', storeId: 'exp-taxes-comment', label: 'Taxes Comment', section: 'calc', subsection: 'expenses', type: 'text', inputSource: 'user-input', required: false },
  { id: 'exp-insurance-comment', storeId: 'exp-insurance-comment', label: 'Insurance Comment', section: 'calc', subsection: 'expenses', type: 'text', inputSource: 'user-input', required: false },
  { id: 'exp-repairs-comment', storeId: 'exp-repairs-comment', label: 'Repairs Comment', section: 'calc', subsection: 'expenses', type: 'text', inputSource: 'user-input', required: false },
  { id: 'exp-payroll-comment', storeId: 'exp-payroll-comment', label: 'Payroll Comment', section: 'calc', subsection: 'expenses', type: 'text', inputSource: 'user-input', required: false },
  { id: 'exp-utilities-comment', storeId: 'exp-utilities-comment', label: 'Utilities Comment', section: 'calc', subsection: 'expenses', type: 'text', inputSource: 'user-input', required: false },
  { id: 'exp-management-comment', storeId: 'exp-management-comment', label: 'Management Comment', section: 'calc', subsection: 'expenses', type: 'text', inputSource: 'user-input', required: false },
  { id: 'exp-other-comment', storeId: 'exp-other-comment', label: 'Other Comment', section: 'calc', subsection: 'expenses', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'dircap-cap-rate1', storeId: 'dircap-cap-rate1', label: 'Capitalization Rate 1', section: 'calc', subsection: 'calc-cap', type: 'percentage', inputSource: 'calculated', required: false, valcreRange: 'IA_DirCap_CapRate1' },
  { id: 'dircap-cap-rate2', storeId: 'dircap-cap-rate2', label: 'Capitalization Rate 2', section: 'calc', subsection: 'calc-cap', type: 'percentage', inputSource: 'calculated', required: false, valcreRange: 'IA_DirCap_CapRate2' },
  ...
  { id: 'hist-revenue-multifamily-total', storeId: 'hist-revenue-multifamily-total', label: 'Multifamily Revenue', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-revenue-multifamily-per-unit', storeId: 'hist-revenue-multifamily-per-unit', label: 'Multifamily Revenue/Unit', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-revenue-multifamily-pct-pgr', storeId: 'hist-revenue-multifamily-pct-pgr', label: 'Multifamily Revenue % PGR', section: 'calc-output', subsection: 'hist-revenue', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-revenue-rental-total', storeId: 'hist-revenue-rental-total', label: 'Rental Revenue', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-revenue-rental-per-unit', storeId: 'hist-revenue-rental-per-unit', label: 'Rental Revenue/Unit', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-revenue-rental-pct-pgr', storeId: 'hist-revenue-rental-pct-pgr', label: 'Rental Revenue % PGR', section: 'calc-output', subsection: 'hist-revenue', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-revenue-parking-total', storeId: 'hist-revenue-parking-total', label: 'Parking Revenue', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-revenue-parking-per-unit', storeId: 'hist-revenue-parking-per-unit', label: 'Parking Revenue/Unit', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-revenue-parking-pct-pgr', storeId: 'hist-revenue-parking-pct-pgr', label: 'Parking Revenue % PGR', section: 'calc-output', subsection: 'hist-revenue', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-revenue-laundry-total', storeId: 'hist-revenue-laundry-total', label: 'Laundry Revenue', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-revenue-laundry-per-unit', storeId: 'hist-revenue-laundry-per-unit', label: 'Laundry Revenue/Unit', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-revenue-laundry-pct-pgr', storeId: 'hist-revenue-laundry-pct-pgr', label: 'Laundry Revenue % PGR', section: 'calc-output', subsection: 'hist-revenue', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-revenue-misc-total', storeId: 'hist-revenue-misc-total', label: 'Misc Revenue', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-revenue-misc-per-unit', storeId: 'hist-revenue-misc-per-unit', label: 'Misc Revenue/Unit', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-revenue-misc-pct-pgr', storeId: 'hist-revenue-misc-pct-pgr', label: 'Misc Revenue % PGR', section: 'calc-output', subsection: 'hist-revenue', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-pgr-total', storeId: 'hist-pgr-total', label: 'PGR Total', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-pgr-per-unit', storeId: 'hist-pgr-per-unit', label: 'PGR/Unit', section: 'calc-output', subsection: 'hist-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-pgr-pct', storeId: 'hist-pgr-pct', label: 'PGR %', section: 'calc-output', subsection: 'hist-revenue', type: 'percentage', inputSource: 'calculated', required: false },

  // Hist - Vacancy/EGR Subsection (6 fields)
  { id: 'hist-vacancy-total', storeId: 'hist-vacancy-total', label: 'Vacancy Loss', section: 'calc-output', subsection: 'hist-vacancy', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-vacancy-per-unit', storeId: 'hist-vacancy-per-unit', label: 'Vacancy/Unit', section: 'calc-output', subsection: 'hist-vacancy', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-vacancy-pct-pgr', storeId: 'hist-vacancy-pct-pgr', label: 'Vacancy % PGR', section: 'calc-output', subsection: 'hist-vacancy', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-egr-total', storeId: 'hist-egr-total', label: 'EGR Total', section: 'calc-output', subsection: 'hist-vacancy', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-egr-per-unit', storeId: 'hist-egr-per-unit', label: 'EGR/Unit', section: 'calc-output', subsection: 'hist-vacancy', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-egr-pct-pgr', storeId: 'hist-egr-pct-pgr', label: 'EGR % PGR', section: 'calc-output', subsection: 'hist-vacancy', type: 'percentage', inputSource: 'calculated', required: false },

  // Hist - Expenses Subsection (24 fields)
  { id: 'hist-exp-taxes-total', storeId: 'hist-exp-taxes-total', label: 'Taxes', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-exp-taxes-per-unit', storeId: 'hist-exp-taxes-per-unit', label: 'Taxes/Unit', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-exp-taxes-pct-pgr', storeId: 'hist-exp-taxes-pct-pgr', label: 'Taxes % PGR', section: 'calc-output', subsection: 'hist-expenses', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-exp-insurance-total', storeId: 'hist-exp-insurance-total', label: 'Insurance', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-exp-insurance-per-unit', storeId: 'hist-exp-insurance-per-unit', label: 'Insurance/Unit', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-exp-insurance-pct-pgr', storeId: 'hist-exp-insurance-pct-pgr', label: 'Insurance % PGR', section: 'calc-output', subsection: 'hist-expenses', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-exp-repairs-total', storeId: 'hist-exp-repairs-total', label: 'Repairs & Maintenance', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-exp-repairs-per-unit', storeId: 'hist-exp-repairs-per-unit', label: 'Repairs/Unit', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-exp-repairs-pct-pgr', storeId: 'hist-exp-repairs-pct-pgr', label: 'Repairs % PGR', section: 'calc-output', subsection: 'hist-expenses', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-exp-payroll-total', storeId: 'hist-exp-payroll-total', label: 'Payroll', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-exp-payroll-per-unit', storeId: 'hist-exp-payroll-per-unit', label: 'Payroll/Unit', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-exp-payroll-pct-pgr', storeId: 'hist-exp-payroll-pct-pgr', label: 'Payroll % PGR', section: 'calc-output', subsection: 'hist-expenses', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-exp-utilities-total', storeId: 'hist-exp-utilities-total', label: 'Utilities', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-exp-utilities-per-unit', storeId: 'hist-exp-utilities-per-unit', label: 'Utilities/Unit', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-exp-utilities-pct-pgr', storeId: 'hist-exp-utilities-pct-pgr', label: 'Utilities % PGR', section: 'calc-output', subsection: 'hist-expenses', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-exp-management-total', storeId: 'hist-exp-management-total', label: 'Management', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-exp-management-per-unit', storeId: 'hist-exp-management-per-unit', label: 'Management/Unit', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-exp-management-pct-pgr', storeId: 'hist-exp-management-pct-pgr', label: 'Management % PGR', section: 'calc-output', subsection: 'hist-expenses', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-exp-other-total', storeId: 'hist-exp-other-total', label: 'Other Expenses', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'hist-exp-other-per-unit', storeId: 'hist-exp-other-per-unit', label: 'Other/Unit', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-exp-other-pct-pgr', storeId: 'hist-exp-other-pct-pgr', label: 'Other % PGR', section: 'calc-output', subsection: 'hist-expenses', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'hist-exp-total-total', storeId: 'hist-exp-total-total', label: 'Total Expenses', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-exp-total-per-unit', storeId: 'hist-exp-total-per-unit', label: 'Total Expenses/Unit', section: 'calc-output', subsection: 'hist-expenses', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-exp-total-pct-pgr', storeId: 'hist-exp-total-pct-pgr', label: 'Total Expenses % PGR', section: 'calc-output', subsection: 'hist-expenses', type: 'percentage', inputSource: 'calculated', required: false },

  // Hist - NOI Subsection (3 fields)
  { id: 'hist-noi-total', storeId: 'hist-noi-total', label: 'NOI', section: 'calc-output', subsection: 'hist-noi', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-noi-per-unit', storeId: 'hist-noi-per-unit', label: 'NOI/Unit', section: 'calc-output', subsection: 'hist-noi', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'hist-noi-pct-pgr', storeId: 'hist-noi-pct-pgr', label: 'NOI % PGR', section: 'calc-output', subsection: 'hist-noi', type: 'percentage', inputSource: 'calculated', required: false },
  ...
  { id: 'survey-intro', storeId: 'survey-intro', label: 'Rental Survey Introduction', section: 'rent-analysis', subsection: 'survey-narratives', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'survey-methodology', storeId: 'survey-methodology', label: 'Survey Methodology', section: 'rent-analysis', subsection: 'survey-narratives', type: 'textarea', inputSource: 'user-input', required: false },

  // --- SURVEY SUMMARY ---
  { id: 'contract-to-market-pct', storeId: 'contract-to-market-pct', label: 'Contract to Market %', section: 'calc-output', subsection: 'survey-summary', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'survey-1br-avg-rent', storeId: 'survey-1br-avg-rent', label: '1BR Average Rent', section: 'calc-output', subsection: 'survey-summary', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'survey-1br-avg-psf', storeId: 'survey-1br-avg-psf', label: '1BR Average PSF', section: 'calc-output', subsection: 'survey-summary', type: 'number', inputSource: 'calculated', required: false },
  { id: 'survey-2br-avg-rent', storeId: 'survey-2br-avg-rent', label: '2BR Average Rent', section: 'calc-output', subsection: 'survey-summary', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'survey-2br-avg-psf', storeId: 'survey-2br-avg-psf', label: '2BR Average PSF', section: 'calc-output', subsection: 'survey-summary', type: 'number', inputSource: 'calculated', required: false },

  // --- RENTAL COMP 1 ---
  { id: 'survey1-name', storeId: 'survey1-name', label: 'Property Name', section: 'calc-output', subsection: 'rental-comp-1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey1-address', storeId: 'survey1-address', label: 'Address', section: 'calc-output', subsection: 'rental-comp-1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey1-city', storeId: 'survey1-city', label: 'City', section: 'calc-output', subsection: 'rental-comp-1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey1-distance', storeId: 'survey1-distance', label: 'Distance (km)', section: 'calc-output', subsection: 'rental-comp-1', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey1-units', storeId: 'survey1-units', label: 'Total Units', section: 'calc-output', subsection: 'rental-comp-1', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey1-year-built', storeId: 'survey1-year-built', label: 'Year Built', section: 'calc-output', subsection: 'rental-comp-1', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey1-stories', storeId: 'survey1-stories', label: 'Stories', section: 'calc-output', subsection: 'rental-comp-1', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey1-location', storeId: 'survey1-location', label: 'Location Rating', section: 'calc-output', subsection: 'rental-comp-1', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey1-quality', storeId: 'survey1-quality', label: 'Quality Rating', section: 'calc-output', subsection: 'rental-comp-1', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey1-condition', storeId: 'survey1-condition', label: 'Condition Rating', section: 'calc-output', subsection: 'rental-comp-1', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey1-appeal', storeId: 'survey1-appeal', label: 'Appeal Rating', section: 'calc-output', subsection: 'rental-comp-1', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey1-amenities', storeId: 'survey1-amenities', label: 'Amenities Rating', section: 'calc-output', subsection: 'rental-comp-1', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey1-parking', storeId: 'survey1-parking', label: 'Parking', section: 'calc-output', subsection: 'rental-comp-1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey1-laundry', storeId: 'survey1-laundry', label: 'Laundry', section: 'calc-output', subsection: 'rental-comp-1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey1-utilities', storeId: 'survey1-utilities', label: 'Utilities Included', section: 'calc-output', subsection: 'rental-comp-1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey1-1br-sf', storeId: 'survey1-1br-sf', label: '1BR Avg SF', section: 'calc-output', subsection: 'rental-comp-1', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey1-1br-rent', storeId: 'survey1-1br-rent', label: '1BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-1', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey1-1br-psf', storeId: 'survey1-1br-psf', label: '1BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-1', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'survey1-2br-sf', storeId: 'survey1-2br-sf', label: '2BR Avg SF', section: 'calc-output', subsection: 'rental-comp-1', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey1-2br-rent', storeId: 'survey1-2br-rent', label: '2BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-1', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey1-2br-psf', storeId: 'survey1-2br-psf', label: '2BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-1', type: 'calculated', inputSource: 'calculated', required: false },

  // --- RENTAL COMP 2 ---
  { id: 'survey2-name', storeId: 'survey2-name', label: 'Property Name', section: 'calc-output', subsection: 'rental-comp-2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey2-address', storeId: 'survey2-address', label: 'Address', section: 'calc-output', subsection: 'rental-comp-2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey2-city', storeId: 'survey2-city', label: 'City', section: 'calc-output', subsection: 'rental-comp-2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey2-distance', storeId: 'survey2-distance', label: 'Distance (km)', section: 'calc-output', subsection: 'rental-comp-2', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey2-units', storeId: 'survey2-units', label: 'Total Units', section: 'calc-output', subsection: 'rental-comp-2', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey2-year-built', storeId: 'survey2-year-built', label: 'Year Built', section: 'calc-output', subsection: 'rental-comp-2', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey2-stories', storeId: 'survey2-stories', label: 'Stories', section: 'calc-output', subsection: 'rental-comp-2', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey2-location', storeId: 'survey2-location', label: 'Location Rating', section: 'calc-output', subsection: 'rental-comp-2', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey2-quality', storeId: 'survey2-quality', label: 'Quality Rating', section: 'calc-output', subsection: 'rental-comp-2', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey2-condition', storeId: 'survey2-condition', label: 'Condition Rating', section: 'calc-output', subsection: 'rental-comp-2', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey2-appeal', storeId: 'survey2-appeal', label: 'Appeal Rating', section: 'calc-output', subsection: 'rental-comp-2', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey2-amenities', storeId: 'survey2-amenities', label: 'Amenities Rating', section: 'calc-output', subsection: 'rental-comp-2', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey2-parking', storeId: 'survey2-parking', label: 'Parking', section: 'calc-output', subsection: 'rental-comp-2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey2-laundry', storeId: 'survey2-laundry', label: 'Laundry', section: 'calc-output', subsection: 'rental-comp-2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey2-utilities', storeId: 'survey2-utilities', label: 'Utilities Included', section: 'calc-output', subsection: 'rental-comp-2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey2-1br-sf', storeId: 'survey2-1br-sf', label: '1BR Avg SF', section: 'calc-output', subsection: 'rental-comp-2', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey2-1br-rent', storeId: 'survey2-1br-rent', label: '1BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-2', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey2-1br-psf', storeId: 'survey2-1br-psf', label: '1BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-2', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'survey2-2br-sf', storeId: 'survey2-2br-sf', label: '2BR Avg SF', section: 'calc-output', subsection: 'rental-comp-2', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey2-2br-rent', storeId: 'survey2-2br-rent', label: '2BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-2', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey2-2br-psf', storeId: 'survey2-2br-psf', label: '2BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-2', type: 'calculated', inputSource: 'calculated', required: false },

  // --- RENTAL COMP 3 ---
  { id: 'survey3-name', storeId: 'survey3-name', label: 'Property Name', section: 'calc-output', subsection: 'rental-comp-3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey3-address', storeId: 'survey3-address', label: 'Address', section: 'calc-output', subsection: 'rental-comp-3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey3-city', storeId: 'survey3-city', label: 'City', section: 'calc-output', subsection: 'rental-comp-3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey3-distance', storeId: 'survey3-distance', label: 'Distance (km)', section: 'calc-output', subsection: 'rental-comp-3', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey3-units', storeId: 'survey3-units', label: 'Total Units', section: 'calc-output', subsection: 'rental-comp-3', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey3-year-built', storeId: 'survey3-year-built', label: 'Year Built', section: 'calc-output', subsection: 'rental-comp-3', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey3-stories', storeId: 'survey3-stories', label: 'Stories', section: 'calc-output', subsection: 'rental-comp-3', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey3-location', storeId: 'survey3-location', label: 'Location Rating', section: 'calc-output', subsection: 'rental-comp-3', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey3-quality', storeId: 'survey3-quality', label: 'Quality Rating', section: 'calc-output', subsection: 'rental-comp-3', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey3-condition', storeId: 'survey3-condition', label: 'Condition Rating', section: 'calc-output', subsection: 'rental-comp-3', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey3-appeal', storeId: 'survey3-appeal', label: 'Appeal Rating', section: 'calc-output', subsection: 'rental-comp-3', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey3-amenities', storeId: 'survey3-amenities', label: 'Amenities Rating', section: 'calc-output', subsection: 'rental-comp-3', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey3-parking', storeId: 'survey3-parking', label: 'Parking', section: 'calc-output', subsection: 'rental-comp-3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey3-laundry', storeId: 'survey3-laundry', label: 'Laundry', section: 'calc-output', subsection: 'rental-comp-3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey3-utilities', storeId: 'survey3-utilities', label: 'Utilities Included', section: 'calc-output', subsection: 'rental-comp-3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey3-1br-sf', storeId: 'survey3-1br-sf', label: '1BR Avg SF', section: 'calc-output', subsection: 'rental-comp-3', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey3-1br-rent', storeId: 'survey3-1br-rent', label: '1BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-3', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey3-1br-psf', storeId: 'survey3-1br-psf', label: '1BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-3', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'survey3-2br-sf', storeId: 'survey3-2br-sf', label: '2BR Avg SF', section: 'calc-output', subsection: 'rental-comp-3', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey3-2br-rent', storeId: 'survey3-2br-rent', label: '2BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-3', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey3-2br-psf', storeId: 'survey3-2br-psf', label: '2BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-3', type: 'calculated', inputSource: 'calculated', required: false },

  // --- RENTAL COMP 4 ---
  { id: 'survey4-name', storeId: 'survey4-name', label: 'Property Name', section: 'calc-output', subsection: 'rental-comp-4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey4-address', storeId: 'survey4-address', label: 'Address', section: 'calc-output', subsection: 'rental-comp-4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey4-city', storeId: 'survey4-city', label: 'City', section: 'calc-output', subsection: 'rental-comp-4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey4-distance', storeId: 'survey4-distance', label: 'Distance (km)', section: 'calc-output', subsection: 'rental-comp-4', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey4-units', storeId: 'survey4-units', label: 'Total Units', section: 'calc-output', subsection: 'rental-comp-4', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey4-year-built', storeId: 'survey4-year-built', label: 'Year Built', section: 'calc-output', subsection: 'rental-comp-4', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey4-stories', storeId: 'survey4-stories', label: 'Stories', section: 'calc-output', subsection: 'rental-comp-4', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey4-location', storeId: 'survey4-location', label: 'Location Rating', section: 'calc-output', subsection: 'rental-comp-4', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey4-quality', storeId: 'survey4-quality', label: 'Quality Rating', section: 'calc-output', subsection: 'rental-comp-4', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey4-condition', storeId: 'survey4-condition', label: 'Condition Rating', section: 'calc-output', subsection: 'rental-comp-4', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey4-appeal', storeId: 'survey4-appeal', label: 'Appeal Rating', section: 'calc-output', subsection: 'rental-comp-4', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey4-amenities', storeId: 'survey4-amenities', label: 'Amenities Rating', section: 'calc-output', subsection: 'rental-comp-4', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey4-parking', storeId: 'survey4-parking', label: 'Parking', section: 'calc-output', subsection: 'rental-comp-4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey4-laundry', storeId: 'survey4-laundry', label: 'Laundry', section: 'calc-output', subsection: 'rental-comp-4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey4-utilities', storeId: 'survey4-utilities', label: 'Utilities Included', section: 'calc-output', subsection: 'rental-comp-4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey4-1br-sf', storeId: 'survey4-1br-sf', label: '1BR Avg SF', section: 'calc-output', subsection: 'rental-comp-4', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey4-1br-rent', storeId: 'survey4-1br-rent', label: '1BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-4', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey4-1br-psf', storeId: 'survey4-1br-psf', label: '1BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-4', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'survey4-2br-sf', storeId: 'survey4-2br-sf', label: '2BR Avg SF', section: 'calc-output', subsection: 'rental-comp-4', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey4-2br-rent', storeId: 'survey4-2br-rent', label: '2BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-4', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey4-2br-psf', storeId: 'survey4-2br-psf', label: '2BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-4', type: 'calculated', inputSource: 'calculated', required: false },

  // --- RENTAL COMP 5 ---
  { id: 'survey5-name', storeId: 'survey5-name', label: 'Property Name', section: 'calc-output', subsection: 'rental-comp-5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey5-address', storeId: 'survey5-address', label: 'Address', section: 'calc-output', subsection: 'rental-comp-5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey5-city', storeId: 'survey5-city', label: 'City', section: 'calc-output', subsection: 'rental-comp-5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey5-distance', storeId: 'survey5-distance', label: 'Distance (km)', section: 'calc-output', subsection: 'rental-comp-5', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey5-units', storeId: 'survey5-units', label: 'Total Units', section: 'calc-output', subsection: 'rental-comp-5', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey5-year-built', storeId: 'survey5-year-built', label: 'Year Built', section: 'calc-output', subsection: 'rental-comp-5', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey5-stories', storeId: 'survey5-stories', label: 'Stories', section: 'calc-output', subsection: 'rental-comp-5', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey5-location', storeId: 'survey5-location', label: 'Location Rating', section: 'calc-output', subsection: 'rental-comp-5', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey5-quality', storeId: 'survey5-quality', label: 'Quality Rating', section: 'calc-output', subsection: 'rental-comp-5', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey5-condition', storeId: 'survey5-condition', label: 'Condition Rating', section: 'calc-output', subsection: 'rental-comp-5', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey5-appeal', storeId: 'survey5-appeal', label: 'Appeal Rating', section: 'calc-output', subsection: 'rental-comp-5', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey5-amenities', storeId: 'survey5-amenities', label: 'Amenities Rating', section: 'calc-output', subsection: 'rental-comp-5', type: 'select', inputSource: 'user-input', required: false, options: ['Superior', 'Similar', 'Inferior'] },
  { id: 'survey5-parking', storeId: 'survey5-parking', label: 'Parking', section: 'calc-output', subsection: 'rental-comp-5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey5-laundry', storeId: 'survey5-laundry', label: 'Laundry', section: 'calc-output', subsection: 'rental-comp-5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey5-utilities', storeId: 'survey5-utilities', label: 'Utilities Included', section: 'calc-output', subsection: 'rental-comp-5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'survey5-1br-sf', storeId: 'survey5-1br-sf', label: '1BR Avg SF', section: 'calc-output', subsection: 'rental-comp-5', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey5-1br-rent', storeId: 'survey5-1br-rent', label: '1BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-5', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey5-1br-psf', storeId: 'survey5-1br-psf', label: '1BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-5', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'survey5-2br-sf', storeId: 'survey5-2br-sf', label: '2BR Avg SF', section: 'calc-output', subsection: 'rental-comp-5', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey5-2br-rent', storeId: 'survey5-2br-rent', label: '2BR Rent/Mo', section: 'calc-output', subsection: 'rental-comp-5', type: 'number', inputSource: 'user-input', required: false },
  { id: 'survey5-2br-psf', storeId: 'survey5-2br-psf', label: '2BR Rent/SF', section: 'calc-output', subsection: 'rental-comp-5', type: 'calculated', inputSource: 'calculated', required: false },

  // --- RENT ANALYSIS: 1 BEDROOM ---
  { id: 'rent-1br-high', storeId: 'rent-1br-high', label: '1BR High Rent', section: 'calc-output', subsection: 'rent-analysis-1br', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'rent-1br-low', storeId: 'rent-1br-low', label: '1BR Low Rent', section: 'calc-output', subsection: 'rent-analysis-1br', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'rent-1br-avg', storeId: 'rent-1br-avg', label: '1BR Average Rent', section: 'calc-output', subsection: 'rent-analysis-1br', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'rent-1br-median', storeId: 'rent-1br-median', label: '1BR Median Rent', section: 'calc-output', subsection: 'rent-analysis-1br', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'rent-1br-concluded-sf', storeId: 'rent-1br-concluded-sf', label: '1BR Concluded SF', section: 'calc-output', subsection: 'rent-analysis-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'rent-1br-concluded-rent', storeId: 'rent-1br-concluded-rent', label: '1BR Concluded Rent', section: 'calc-output', subsection: 'rent-analysis-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'rent-1br-concluded-psf', storeId: 'rent-1br-concluded-psf', label: '1BR Concluded Rent/SF', section: 'calc-output', subsection: 'rent-analysis-1br', type: 'calculated', inputSource: 'calculated', required: false },

  // --- RENT ANALYSIS: 2 BEDROOM ---
  { id: 'rent-2br-high', storeId: 'rent-2br-high', label: '2BR High Rent', section: 'calc-output', subsection: 'rent-analysis-2br', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'rent-2br-low', storeId: 'rent-2br-low', label: '2BR Low Rent', section: 'calc-output', subsection: 'rent-analysis-2br', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'rent-2br-avg', storeId: 'rent-2br-avg', label: '2BR Average Rent', section: 'calc-output', subsection: 'rent-analysis-2br', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'rent-2br-median', storeId: 'rent-2br-median', label: '2BR Median Rent', section: 'calc-output', subsection: 'rent-analysis-2br', type: 'calculated', inputSource: 'calculated', required: false },
  { id: 'rent-2br-concluded-sf', storeId: 'rent-2br-concluded-sf', label: '2BR Concluded SF', section: 'calc-output', subsection: 'rent-analysis-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'rent-2br-concluded-rent', storeId: 'rent-2br-concluded-rent', label: '2BR Concluded Rent', section: 'calc-output', subsection: 'rent-analysis-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'rent-2br-concluded-psf', storeId: 'rent-2br-concluded-psf', label: '2BR Concluded Rent/SF', section: 'calc-output', subsection: 'rent-analysis-2br', type: 'calculated', inputSource: 'calculated', required: false },

  // --- SURVEY CONCLUSION ---
  { id: 'survey-conclusion', storeId: 'survey-conclusion', label: 'Rental Survey Conclusion', section: 'rent-analysis', subsection: 'survey-narratives', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'survey-market-rent-support', storeId: 'survey-market-rent-support', label: 'Market Rent Support Narrative', section: 'rent-analysis', subsection: 'survey-narratives', type: 'textarea', inputSource: 'user-input', required: false },
  ...
  { id: 'income-cap-rate-analysis', storeId: 'income-cap-rate-analysis', label: 'Cap Rate Analysis', section: 'income', subsection: 'calc-output', type: 'textarea', inputSource: 'user-input', required: false },
  ...
  { id: 'cap-rate-average', storeId: 'cap-rate-average', label: 'Cap Rate Average', section: 'income', subsection: 'cap-rate-analysis', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'cap-rate-high', storeId: 'cap-rate-high', label: 'Cap Rate High', section: 'income', subsection: 'cap-rate-analysis', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'cap-rate-implied-range', storeId: 'cap-rate-implied-range', label: 'Cap Rate Implied Range', section: 'income', subsection: 'cap-rate-analysis', type: 'text', inputSource: 'calculated', required: false },
  { id: 'cap-rate-low', storeId: 'cap-rate-low', label: 'Cap Rate Low', section: 'income', subsection: 'cap-rate-analysis', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'cap-rate-range', storeId: 'cap-rate-range', label: 'Cap Rate Range', section: 'income', subsection: 'cap-rate-analysis', type: 'text', inputSource: 'calculated', required: false },
  ...
  { id: 'ia-dircap-cap-rate1', storeId: 'ia-dircap-cap-rate1', label: 'Direct Cap Cap Rate', section: 'income', subsection: 'direct-capitalization', type: 'percentage', inputSource: 'user-input', required: false },
  ...
  { id: 'ia-dircap-noi', storeId: 'ia-dircap-noi', label: 'Direct Cap NOI', section: 'income', subsection: 'direct-capitalization', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'ia-dircap-noi-per-unit', storeId: 'ia-dircap-noi-per-unit', label: 'Direct Cap NOI Per Unit', section: 'income', subsection: 'direct-capitalization', type: 'currency', inputSource: 'calculated', required: false },
  ...
  { id: 'income-value-indication', storeId: 'income-value-indication', label: 'Income Approach Value', section: 'income', subsection: 'calc-output', type: 'number', inputSource: 'calculated', required: false },
  ...
  { id: 'subject-actualage', storeId: 'subject-actualage', label: 'Actual Age', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-city', storeId: 'subject-city', label: 'City', section: 'cover', subsection: 'property-address', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-effectiveage', storeId: 'subject-effectiveage', label: 'Effective Age', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-economiclife', storeId: 'subject-economiclife', label: 'Economic Life', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-geocode', storeId: 'subject-geocode', label: 'Geocode', section: 'cover', subsection: 'property-address', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-location', storeId: 'subject-location', label: 'Location', section: 'cover', subsection: 'property-address', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-market', storeId: 'subject-market', label: 'Market', section: 'cover', subsection: 'property-address', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-nra', storeId: 'subject-nra', label: 'Net Rentable Area', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-owner', storeId: 'subject-owner', label: 'Owner', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-property-name', storeId: 'subject-property-name', label: 'Property Name', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-province', storeId: 'subject-province', label: 'Province', section: 'cover', subsection: 'property-address', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-remaininglife', storeId: 'subject-remaininglife', label: 'Remaining Life', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-state', storeId: 'subject-state', label: 'State', section: 'cover', subsection: 'property-address', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-street', storeId: 'subject-street', label: 'Street', section: 'cover', subsection: 'property-address', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-submarket', storeId: 'subject-submarket', label: 'Submarket', section: 'cover', subsection: 'property-address', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-zip', storeId: 'subject-zip', label: 'Zip Code', section: 'cover', subsection: 'property-address', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-zoning', storeId: 'subject-zoning', label: 'Zoning', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-zoningcode', storeId: 'subject-zoningcode', label: 'Zoning Code', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-zoningdescription', storeId: 'subject-zoningdescription', label: 'Zoning Description', section: 'exec', subsection: 'property-identification', type: 'textarea', inputSource: 'user-input', required: false },

  // Subject Property - Amenities & Features
  { id: 'subject-amenities-laundry', storeId: 'subject-amenities-laundry', label: 'Amenities - Laundry', section: 'impv', subsection: 'amenities', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-amenities-parking', storeId: 'subject-amenities-parking', label: 'Amenities - Parking', section: 'impv', subsection: 'amenities', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-amenities-utilities', storeId: 'subject-amenities-utilities', label: 'Amenities - Utilities', section: 'impv', subsection: 'amenities', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-appeal', storeId: 'subject-appeal', label: 'Appeal', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-concludedrent', storeId: 'subject-concludedrent', label: 'Concluded Rent', section: 'calc-output', subsection: 'rent-conclusion', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'subject-conforminglot', storeId: 'subject-conforminglot', label: 'Conforming Lot', section: 'exec', subsection: 'property-identification', type: 'select', inputSource: 'user-input', required: false, options: ['Yes', 'No'] },
  { id: 'subject-conforminguse', storeId: 'subject-conforminguse', label: 'Conforming Use', section: 'exec', subsection: 'property-identification', type: 'select', inputSource: 'user-input', required: false, options: ['Yes', 'No', 'Non-Conforming'] },
  { id: 'subject-currentrent', storeId: 'subject-currentrent', label: 'Current Rent', section: 'calc-output', subsection: 'current-rent', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'subject-density', storeId: 'subject-density', label: 'Density', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-econcharacteristics', storeId: 'subject-econcharacteristics', label: 'Economic Characteristics', section: 'exec', subsection: 'property-identification', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-exposuretime', storeId: 'subject-exposuretime', label: 'Exposure Time', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-hbuimproved', storeId: 'subject-hbuimproved', label: 'HBU As Improved', section: 'hbu', subsection: 'hbu-as-improved', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-hbuvacant', storeId: 'subject-hbuvacant', label: 'HBU As Vacant', section: 'hbu', subsection: 'hbu-as-vacant', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-introcomment', storeId: 'subject-introcomment', label: 'Introduction Comment', section: 'exec', subsection: 'property-identification', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-laundry', storeId: 'subject-laundry', label: 'Laundry', section: 'impv', subsection: 'amenities', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-legally-permitted', storeId: 'subject-legally-permitted', label: 'Legally Permitted', section: 'exec', subsection: 'property-identification', type: 'select', inputSource: 'user-input', required: false, options: ['Yes', 'No'] },
  { id: 'subject-marketing', storeId: 'subject-marketing', label: 'Marketing Time', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-occupancy-current', storeId: 'subject-occupancy-current', label: 'Current Occupancy', section: 'exec', subsection: 'property-identification', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'subject-occupancystabilized', storeId: 'subject-occupancystabilized', label: 'Stabilized Occupancy', section: 'exec', subsection: 'property-identification', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'subject-occupied-units', storeId: 'subject-occupied-units', label: 'Occupied Units', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-photo-2', storeId: 'subject-photo-2', label: 'Subject Photo 2', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-3', storeId: 'subject-photo-3', label: 'Subject Photo 3', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-4', storeId: 'subject-photo-4', label: 'Subject Photo 4', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-5', storeId: 'subject-photo-5', label: 'Subject Photo 5', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-6', storeId: 'subject-photo-6', label: 'Subject Photo 6', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-7', storeId: 'subject-photo-7', label: 'Subject Photo 7', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-8', storeId: 'subject-photo-8', label: 'Subject Photo 8', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-9', storeId: 'subject-photo-9', label: 'Subject Photo 9', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-10', storeId: 'subject-photo-10', label: 'Subject Photo 10', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-11', storeId: 'subject-photo-11', label: 'Subject Photo 11', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-12', storeId: 'subject-photo-12', label: 'Subject Photo 12', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-13', storeId: 'subject-photo-13', label: 'Subject Photo 13', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-14', storeId: 'subject-photo-14', label: 'Subject Photo 14', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-15', storeId: 'subject-photo-15', label: 'Subject Photo 15', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-16', storeId: 'subject-photo-16', label: 'Subject Photo 16', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-17', storeId: 'subject-photo-17', label: 'Subject Photo 17', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-18', storeId: 'subject-photo-18', label: 'Subject Photo 18', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-19', storeId: 'subject-photo-19', label: 'Subject Photo 19', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-20', storeId: 'subject-photo-20', label: 'Subject Photo 20', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-21', storeId: 'subject-photo-21', label: 'Subject Photo 21', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-22', storeId: 'subject-photo-22', label: 'Subject Photo 22', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-23', storeId: 'subject-photo-23', label: 'Subject Photo 23', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-24', storeId: 'subject-photo-24', label: 'Subject Photo 24', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-photo-25', storeId: 'subject-photo-25', label: 'Subject Photo 25', section: 'image-mgt', subsection: 'common-photos', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-primary', storeId: 'subject-primary', label: 'Primary Type', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-proj-amenities', storeId: 'subject-proj-amenities', label: 'Project Amenities', section: 'impv', subsection: 'amenities', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-proposedconstruction', storeId: 'subject-proposedconstruction', label: 'Proposed Construction', section: 'exec', subsection: 'property-identification', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-quality', storeId: 'subject-quality', label: 'Quality', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },

  // Subject Property - Rent, Site & Tax Info
  { id: 'subject-rent-sf-avg', storeId: 'subject-rent-sf-avg', label: 'Rent per SF Average', section: 'calc-output', subsection: 'rent-analysis', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'subject-renttype', storeId: 'subject-renttype', label: 'Rent Type', section: 'calc-output', subsection: 'rent-analysis', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-rent-unit-avg', storeId: 'subject-rent-unit-avg', label: 'Rent per Unit Average', section: 'calc-output', subsection: 'rent-analysis', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'subject-salehistory', storeId: 'subject-salehistory', label: 'Sale History', section: 'exec', subsection: 'property-identification', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-security', storeId: 'subject-security', label: 'Security', section: 'impv', subsection: 'amenities', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-security-features', storeId: 'subject-security-features', label: 'Security Features', section: 'impv', subsection: 'amenities', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-sfmultifamily', storeId: 'subject-sfmultifamily', label: 'SF Multifamily', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-shape', storeId: 'subject-shape', label: 'Site Shape', section: 'site', subsection: 'site-conditions', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-siteaccess', storeId: 'subject-siteaccess', label: 'Site Access', section: 'site', subsection: 'site-conditions', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-siteexposure', storeId: 'subject-siteexposure', label: 'Site Exposure', section: 'site', subsection: 'site-conditions', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-sitequality', storeId: 'subject-sitequality', label: 'Site Quality', section: 'site', subsection: 'site-conditions', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-siteutility', storeId: 'subject-siteutility', label: 'Site Utility', section: 'site', subsection: 'site-conditions', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-stories', storeId: 'subject-stories', label: 'Number of Stories', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-subtype', storeId: 'subject-subtype', label: 'Property Subtype', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-surveycomments', storeId: 'subject-surveycomments', label: 'Survey Comments', section: 'calc-output', subsection: 'rent-analysis', type: 'textarea', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-tax-per-sf', storeId: 'subject-tax-per-sf', label: 'Tax per SF', section: 'tax', subsection: 'tax-info', type: 'currency', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-tenancy', storeId: 'subject-tenancy', label: 'Tenancy', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-topography', storeId: 'subject-topography', label: 'Topography', section: 'site', subsection: 'site-conditions', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-totalacre', storeId: 'subject-totalacre', label: 'Total Acres', section: 'site', subsection: 'site-area', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-totalbuildings', storeId: 'subject-totalbuildings', label: 'Total Buildings', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-totalsf', storeId: 'subject-totalsf', label: 'Total SF', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-unit-amenities', storeId: 'subject-unit-amenities', label: 'Unit Amenities', section: 'impv', subsection: 'amenities', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-usableacre', storeId: 'subject-usableacre', label: 'Usable Acre', section: 'site', subsection: 'site-area', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-usableacres', storeId: 'subject-usableacres', label: 'Usable Acres', section: 'site', subsection: 'site-area', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-usablesf', storeId: 'subject-usablesf', label: 'Usable SF', section: 'site', subsection: 'site-area', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-utilities', storeId: 'subject-utilities', label: 'Utilities', section: 'site', subsection: 'site-conditions', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-vacancycreditloss', storeId: 'subject-vacancycreditloss', label: 'Vacancy & Credit Loss', section: 'calc-output', subsection: 'vacancy-loss', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'subject-vacant-units', storeId: 'subject-vacant-units', label: 'Vacant Units', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-zoningauthority', storeId: 'subject-zoningauthority', label: 'Zoning Authority', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-zoningchange', storeId: 'subject-zoningchange', label: 'Zoning Change', section: 'exec', subsection: 'property-identification', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'subject-zoningchangestatus', storeId: 'subject-zoningchangestatus', label: 'Zoning Change Status', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },

  // Market Rent - 1 Bedroom Fields
  { id: 'market-rent-1bed-avg-rentsf', storeId: 'market-rent-1bed-avg-rentsf', label: '1BR Avg Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-avg-rentsf-unadj', storeId: 'market-rent-1bed-avg-rentsf-unadj', label: '1BR Avg Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-avg-rentunit', storeId: 'market-rent-1bed-avg-rentunit', label: '1BR Avg Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-avg-unitsize', storeId: 'market-rent-1bed-avg-unitsize', label: '1BR Avg Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp1-rentsf', storeId: 'market-rent-1bed-comp1-rentsf', label: '1BR Comp1 Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp1-rentsf-unadj', storeId: 'market-rent-1bed-comp1-rentsf-unadj', label: '1BR Comp1 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp1-rentunit', storeId: 'market-rent-1bed-comp1-rentunit', label: '1BR Comp1 Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp1-unitsize', storeId: 'market-rent-1bed-comp1-unitsize', label: '1BR Comp1 Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp2-rentsf', storeId: 'market-rent-1bed-comp2-rentsf', label: '1BR Comp2 Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp2-rentsf-unadj', storeId: 'market-rent-1bed-comp2-rentsf-unadj', label: '1BR Comp2 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp2-rentunit', storeId: 'market-rent-1bed-comp2-rentunit', label: '1BR Comp2 Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp2-unitsize', storeId: 'market-rent-1bed-comp2-unitsize', label: '1BR Comp2 Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp3-rentsf', storeId: 'market-rent-1bed-comp3-rentsf', label: '1BR Comp3 Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp3-rentsf-unadj', storeId: 'market-rent-1bed-comp3-rentsf-unadj', label: '1BR Comp3 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp3-rentunit', storeId: 'market-rent-1bed-comp3-rentunit', label: '1BR Comp3 Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp3-unitsize', storeId: 'market-rent-1bed-comp3-unitsize', label: '1BR Comp3 Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp4-rentsf', storeId: 'market-rent-1bed-comp4-rentsf', label: '1BR Comp4 Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp4-rentsf-unadj', storeId: 'market-rent-1bed-comp4-rentsf-unadj', label: '1BR Comp4 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp4-rentunit', storeId: 'market-rent-1bed-comp4-rentunit', label: '1BR Comp4 Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp4-unitsize', storeId: 'market-rent-1bed-comp4-unitsize', label: '1BR Comp4 Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp5-rentsf', storeId: 'market-rent-1bed-comp5-rentsf', label: '1BR Comp5 Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp5-rentsf-unadj', storeId: 'market-rent-1bed-comp5-rentsf-unadj', label: '1BR Comp5 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp5-rentunit', storeId: 'market-rent-1bed-comp5-rentunit', label: '1BR Comp5 Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-comp5-unitsize', storeId: 'market-rent-1bed-comp5-unitsize', label: '1BR Comp5 Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-concluded', storeId: 'market-rent-1bed-concluded', label: '1BR Concluded Rent', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-concluded-sf', storeId: 'market-rent-1bed-concluded-sf', label: '1BR Concluded Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-high-rentsf', storeId: 'market-rent-1bed-high-rentsf', label: '1BR High Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-high-rentsf-unadj', storeId: 'market-rent-1bed-high-rentsf-unadj', label: '1BR High Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-high-rentunit', storeId: 'market-rent-1bed-high-rentunit', label: '1BR High Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-high-unitsize', storeId: 'market-rent-1bed-high-unitsize', label: '1BR High Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-low-rentsf', storeId: 'market-rent-1bed-low-rentsf', label: '1BR Low Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-low-rentsf-unadj', storeId: 'market-rent-1bed-low-rentsf-unadj', label: '1BR Low Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-low-rentunit', storeId: 'market-rent-1bed-low-rentunit', label: '1BR Low Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-low-unitsize', storeId: 'market-rent-1bed-low-unitsize', label: '1BR Low Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-med-rentsf', storeId: 'market-rent-1bed-med-rentsf', label: '1BR Med Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-med-rentsf-unadj', storeId: 'market-rent-1bed-med-rentsf-unadj', label: '1BR Med Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-med-rentunit', storeId: 'market-rent-1bed-med-rentunit', label: '1BR Med Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-med-unitsize', storeId: 'market-rent-1bed-med-unitsize', label: '1BR Med Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-rangehigh', storeId: 'market-rent-1bed-rangehigh', label: '1BR Range High', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-rangelow', storeId: 'market-rent-1bed-rangelow', label: '1BR Range Low', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-sf-high', storeId: 'market-rent-1bed-sf-high', label: '1BR SF High', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed-sf-low', storeId: 'market-rent-1bed-sf-low', label: '1BR SF Low', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed1bath-conclusionsf', storeId: 'market-rent-1bed1bath-conclusionsf', label: '1BR1BA Conclusion/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed1bath-rentsf', storeId: 'market-rent-1bed1bath-rentsf', label: '1BR1BA Rent/SF', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed1bath-rentunit', storeId: 'market-rent-1bed1bath-rentunit', label: '1BR1BA Rent/Unit', section: 'calc-output', subsection: 'market-rent-1br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-1bed1bath-unitsize', storeId: 'market-rent-1bed1bath-unitsize', label: '1BR1BA Unit Size', section: 'calc-output', subsection: 'market-rent-1br', type: 'number', inputSource: 'user-input', required: false },

  // Market Rent - 2 Bedroom Fields
  { id: 'market-rent-2bed-avg-netadj', storeId: 'market-rent-2bed-avg-netadj', label: '2BR Avg Net Adj', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-avg-rentsf', storeId: 'market-rent-2bed-avg-rentsf', label: '2BR Avg Rent/SF', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-avg-rentsf-unadj', storeId: 'market-rent-2bed-avg-rentsf-unadj', label: '2BR Avg Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-avg-rentunit', storeId: 'market-rent-2bed-avg-rentunit', label: '2BR Avg Rent/Unit', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-avg-unitsize', storeId: 'market-rent-2bed-avg-unitsize', label: '2BR Avg Unit Size', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp1-netadj', storeId: 'market-rent-2bed-comp1-netadj', label: '2BR Comp1 Net Adj', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp1-rentsf', storeId: 'market-rent-2bed-comp1-rentsf', label: '2BR Comp1 Rent/SF', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp1-rentsf-unadj', storeId: 'market-rent-2bed-comp1-rentsf-unadj', label: '2BR Comp1 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp1-rentunit', storeId: 'market-rent-2bed-comp1-rentunit', label: '2BR Comp1 Rent/Unit', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp1-unitsize', storeId: 'market-rent-2bed-comp1-unitsize', label: '2BR Comp1 Unit Size', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp2-netadj', storeId: 'market-rent-2bed-comp2-netadj', label: '2BR Comp2 Net Adj', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp2-rentsf', storeId: 'market-rent-2bed-comp2-rentsf', label: '2BR Comp2 Rent/SF', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp2-rentsf-unadj', storeId: 'market-rent-2bed-comp2-rentsf-unadj', label: '2BR Comp2 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp2-rentunit', storeId: 'market-rent-2bed-comp2-rentunit', label: '2BR Comp2 Rent/Unit', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp2-unitsize', storeId: 'market-rent-2bed-comp2-unitsize', label: '2BR Comp2 Unit Size', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp3-netadj', storeId: 'market-rent-2bed-comp3-netadj', label: '2BR Comp3 Net Adj', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp3-rentsf', storeId: 'market-rent-2bed-comp3-rentsf', label: '2BR Comp3 Rent/SF', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp3-rentsf-unadj', storeId: 'market-rent-2bed-comp3-rentsf-unadj', label: '2BR Comp3 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp3-rentunit', storeId: 'market-rent-2bed-comp3-rentunit', label: '2BR Comp3 Rent/Unit', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp3-unitsize', storeId: 'market-rent-2bed-comp3-unitsize', label: '2BR Comp3 Unit Size', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp4-netadj', storeId: 'market-rent-2bed-comp4-netadj', label: '2BR Comp4 Net Adj', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp4-rentsf', storeId: 'market-rent-2bed-comp4-rentsf', label: '2BR Comp4 Rent/SF', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp4-rentsf-unadj', storeId: 'market-rent-2bed-comp4-rentsf-unadj', label: '2BR Comp4 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp4-rentunit', storeId: 'market-rent-2bed-comp4-rentunit', label: '2BR Comp4 Rent/Unit', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp4-unitsize', storeId: 'market-rent-2bed-comp4-unitsize', label: '2BR Comp4 Unit Size', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp5-netadj', storeId: 'market-rent-2bed-comp5-netadj', label: '2BR Comp5 Net Adj', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp5-rentsf', storeId: 'market-rent-2bed-comp5-rentsf', label: '2BR Comp5 Rent/SF', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp5-rentsf-unadj', storeId: 'market-rent-2bed-comp5-rentsf-unadj', label: '2BR Comp5 Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp5-rentunit', storeId: 'market-rent-2bed-comp5-rentunit', label: '2BR Comp5 Rent/Unit', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-comp5-unitsize', storeId: 'market-rent-2bed-comp5-unitsize', label: '2BR Comp5 Unit Size', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-high-rentsf', storeId: 'market-rent-2bed-high-rentsf', label: '2BR High Rent/SF', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-high-rentsf-unadj', storeId: 'market-rent-2bed-high-rentsf-unadj', label: '2BR High Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-high-rentunit', storeId: 'market-rent-2bed-high-rentunit', label: '2BR High Rent/Unit', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-high-unitsize', storeId: 'market-rent-2bed-high-unitsize', label: '2BR High Unit Size', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-low-netadj', storeId: 'market-rent-2bed-low-netadj', label: '2BR Low Net Adj', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-low-rentsf', storeId: 'market-rent-2bed-low-rentsf', label: '2BR Low Rent/SF', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-low-rentsf-unadj', storeId: 'market-rent-2bed-low-rentsf-unadj', label: '2BR Low Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-low-rentunit', storeId: 'market-rent-2bed-low-rentunit', label: '2BR Low Rent/Unit', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-low-unitsize', storeId: 'market-rent-2bed-low-unitsize', label: '2BR Low Unit Size', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-med-rentsf', storeId: 'market-rent-2bed-med-rentsf', label: '2BR Med Rent/SF', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-med-rentsf-unadj', storeId: 'market-rent-2bed-med-rentsf-unadj', label: '2BR Med Rent/SF (Unadj)', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-med-rentunit', storeId: 'market-rent-2bed-med-rentunit', label: '2BR Med Rent/Unit', section: 'calc-output', subsection: 'market-rent-2br', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'market-rent-2bed-med-unitsize', storeId: 'market-rent-2bed-med-unitsize', label: '2BR Med Unit Size', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-comps-count', storeId: 'market-rent-comps-count', label: 'Market Rent Comps Count', section: 'calc-output', subsection: 'market-rent-2br', type: 'number', inputSource: 'user-input', required: false },
  { id: 'market-rent-comps-markets', storeId: 'market-rent-comps-markets', label: 'Market Rent Comps Markets', section: 'calc-output', subsection: 'market-rent-2br', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp1-analysis-price', storeId: 'comp1-analysis-price', label: 'Comp1 Analysis Price', section: 'sales-comparison', subsection: 'comp1', type: 'currency', inputSource: 'user-input', required: false },
  ...
  { id: 'comp1-city-state-zip', storeId: 'comp1-city-state-zip', label: 'Comp1 City State Zip', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp1-conditions-of-sale', storeId: 'comp1-conditions-of-sale', label: 'Comp1 Conditions of Sale', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp1-property-type', storeId: 'comp1-property-type', label: 'Comp1 Property Type', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp1-rights-transferred', storeId: 'comp1-rights-transferred', label: 'Comp1 Rights Transferred', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp1-security-features', storeId: 'comp1-security-features', label: 'Comp1 Security Features', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp1-transaction-status', storeId: 'comp1-transaction-status', label: 'Comp1 Transaction Status', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp1-cap-rate', storeId: 'comp1-cap-rate', label: 'Comp1 Cap Rate', section: 'sales-comparison', subsection: 'comp1', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'comp1-parking-type', storeId: 'comp1-parking-type', label: 'Comp1 Parking Type', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp1-price-per-unit', storeId: 'comp1-price-per-unit', label: 'Comp1 Price Per Unit', section: 'sales-comparison', subsection: 'comp1', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp1-proj-amenities', storeId: 'comp1-proj-amenities', label: 'Comp1 Project Amenities', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp1-property-name', storeId: 'comp1-property-name', label: 'Comp1 Property Name', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp1-sale-date', storeId: 'comp1-sale-date', label: 'Comp1 Sale Date', section: 'sales-comparison', subsection: 'comp1', type: 'date', inputSource: 'user-input', required: false },
  { id: 'comp1-sale-price', storeId: 'comp1-sale-price', label: 'Comp1 Sale Price', section: 'sales-comparison', subsection: 'comp1', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp1-unit-amenities', storeId: 'comp1-unit-amenities', label: 'Comp1 Unit Amenities', section: 'sales-comparison', subsection: 'comp1', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp1-year-built', storeId: 'comp1-year-built', label: 'Comp1 Year Built', section: 'sales-comparison', subsection: 'comp1', type: 'number', inputSource: 'user-input', required: false },
  ...
  { id: 'comp2-analysis-price', storeId: 'comp2-analysis-price', label: 'Comp2 Analysis Price', section: 'sales-comparison', subsection: 'comp2', type: 'currency', inputSource: 'user-input', required: false },
  ...
  { id: 'comp2-city-state-zip', storeId: 'comp2-city-state-zip', label: 'Comp2 City State Zip', section: 'sales-comparison', subsection: 'comp2', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp2-market-conditions', storeId: 'comp2-market-conditions', label: 'Comp2 Market Conditions', section: 'sales-comparison', subsection: 'comp2', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp2-property-type', storeId: 'comp2-property-type', label: 'Comp2 Property Type', section: 'sales-comparison', subsection: 'comp2', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp2-rights-transferred', storeId: 'comp2-rights-transferred', label: 'Comp2 Rights Transferred', section: 'sales-comparison', subsection: 'comp2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp2-security-features', storeId: 'comp2-security-features', label: 'Comp2 Security Features', section: 'sales-comparison', subsection: 'comp2', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp2-transaction-status', storeId: 'comp2-transaction-status', label: 'Comp2 Transaction Status', section: 'sales-comparison', subsection: 'comp2', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp2-cap-rate', storeId: 'comp2-cap-rate', label: 'Comp2 Cap Rate', section: 'sales-comparison', subsection: 'comp2', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'comp2-parking-type', storeId: 'comp2-parking-type', label: 'Comp2 Parking Type', section: 'sales-comparison', subsection: 'comp2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp2-price-per-unit', storeId: 'comp2-price-per-unit', label: 'Comp2 Price Per Unit', section: 'sales-comparison', subsection: 'comp2', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp2-property-name', storeId: 'comp2-property-name', label: 'Comp2 Property Name', section: 'sales-comparison', subsection: 'comp2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp2-sale-date', storeId: 'comp2-sale-date', label: 'Comp2 Sale Date', section: 'sales-comparison', subsection: 'comp2', type: 'date', inputSource: 'user-input', required: false },
  { id: 'comp2-sale-price', storeId: 'comp2-sale-price', label: 'Comp2 Sale Price', section: 'sales-comparison', subsection: 'comp2', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp2-unit-amenities', storeId: 'comp2-unit-amenities', label: 'Comp2 Unit Amenities', section: 'sales-comparison', subsection: 'comp2', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp2-year-built', storeId: 'comp2-year-built', label: 'Comp2 Year Built', section: 'sales-comparison', subsection: 'comp2', type: 'number', inputSource: 'user-input', required: false },
  ...
  { id: 'comp3-analysis-price', storeId: 'comp3-analysis-price', label: 'Comp3 Analysis Price', section: 'sales-comparison', subsection: 'comp3', type: 'currency', inputSource: 'user-input', required: false },
  ...
  { id: 'comp3-city-state-zip', storeId: 'comp3-city-state-zip', label: 'Comp3 City State Zip', section: 'sales-comparison', subsection: 'comp3', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp3-market-conditions', storeId: 'comp3-market-conditions', label: 'Comp3 Market Conditions', section: 'sales-comparison', subsection: 'comp3', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp3-property-type', storeId: 'comp3-property-type', label: 'Comp3 Property Type', section: 'sales-comparison', subsection: 'comp3', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp3-rights-transferred', storeId: 'comp3-rights-transferred', label: 'Comp3 Rights Transferred', section: 'sales-comparison', subsection: 'comp3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp3-security-features', storeId: 'comp3-security-features', label: 'Comp3 Security Features', section: 'sales-comparison', subsection: 'comp3', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp3-transaction-status', storeId: 'comp3-transaction-status', label: 'Comp3 Transaction Status', section: 'sales-comparison', subsection: 'comp3', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp3-cap-rate', storeId: 'comp3-cap-rate', label: 'Comp3 Cap Rate', section: 'sales-comparison', subsection: 'comp3', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'comp3-parking-type', storeId: 'comp3-parking-type', label: 'Comp3 Parking Type', section: 'sales-comparison', subsection: 'comp3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp3-price-per-unit', storeId: 'comp3-price-per-unit', label: 'Comp3 Price Per Unit', section: 'sales-comparison', subsection: 'comp3', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp3-property-name', storeId: 'comp3-property-name', label: 'Comp3 Property Name', section: 'sales-comparison', subsection: 'comp3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp3-sale-date', storeId: 'comp3-sale-date', label: 'Comp3 Sale Date', section: 'sales-comparison', subsection: 'comp3', type: 'date', inputSource: 'user-input', required: false },
  { id: 'comp3-sale-price', storeId: 'comp3-sale-price', label: 'Comp3 Sale Price', section: 'sales-comparison', subsection: 'comp3', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp3-unit-amenities', storeId: 'comp3-unit-amenities', label: 'Comp3 Unit Amenities', section: 'sales-comparison', subsection: 'comp3', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp3-year-built', storeId: 'comp3-year-built', label: 'Comp3 Year Built', section: 'sales-comparison', subsection: 'comp3', type: 'number', inputSource: 'user-input', required: false },
  ...
  { id: 'comp4-analysis-price', storeId: 'comp4-analysis-price', label: 'Comp4 Analysis Price', section: 'sales-comparison', subsection: 'comp4', type: 'currency', inputSource: 'user-input', required: false },
  ...
  { id: 'comp4-city-state-zip', storeId: 'comp4-city-state-zip', label: 'Comp4 City State Zip', section: 'sales-comparison', subsection: 'comp4', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp4-market-conditions', storeId: 'comp4-market-conditions', label: 'Comp4 Market Conditions', section: 'sales-comparison', subsection: 'comp4', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp4-property-type', storeId: 'comp4-property-type', label: 'Comp4 Property Type', section: 'sales-comparison', subsection: 'comp4', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp4-rights-transferred', storeId: 'comp4-rights-transferred', label: 'Comp4 Rights Transferred', section: 'sales-comparison', subsection: 'comp4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp4-security-features', storeId: 'comp4-security-features', label: 'Comp4 Security Features', section: 'sales-comparison', subsection: 'comp4', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp4-transaction-status', storeId: 'comp4-transaction-status', label: 'Comp4 Transaction Status', section: 'sales-comparison', subsection: 'comp4', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp4-cap-rate', storeId: 'comp4-cap-rate', label: 'Comp4 Cap Rate', section: 'sales-comparison', subsection: 'comp4', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'comp4-parking-type', storeId: 'comp4-parking-type', label: 'Comp4 Parking Type', section: 'sales-comparison', subsection: 'comp4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp4-price-per-unit', storeId: 'comp4-price-per-unit', label: 'Comp4 Price Per Unit', section: 'sales-comparison', subsection: 'comp4', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp4-property-name', storeId: 'comp4-property-name', label: 'Comp4 Property Name', section: 'sales-comparison', subsection: 'comp4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp4-sale-date', storeId: 'comp4-sale-date', label: 'Comp4 Sale Date', section: 'sales-comparison', subsection: 'comp4', type: 'date', inputSource: 'user-input', required: false },
  { id: 'comp4-sale-price', storeId: 'comp4-sale-price', label: 'Comp4 Sale Price', section: 'sales-comparison', subsection: 'comp4', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp4-unit-amenities', storeId: 'comp4-unit-amenities', label: 'Comp4 Unit Amenities', section: 'sales-comparison', subsection: 'comp4', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp4-year-built', storeId: 'comp4-year-built', label: 'Comp4 Year Built', section: 'sales-comparison', subsection: 'comp4', type: 'number', inputSource: 'user-input', required: false },
  ...
  { id: 'comp5-analysis-price', storeId: 'comp5-analysis-price', label: 'Comp5 Analysis Price', section: 'sales-comparison', subsection: 'comp5', type: 'currency', inputSource: 'user-input', required: false },
  ...
  { id: 'comp5-city-state-zip', storeId: 'comp5-city-state-zip', label: 'Comp5 City State Zip', section: 'sales-comparison', subsection: 'comp5', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp5-market-conditions', storeId: 'comp5-market-conditions', label: 'Comp5 Market Conditions', section: 'sales-comparison', subsection: 'comp5', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp5-property-type', storeId: 'comp5-property-type', label: 'Comp5 Property Type', section: 'sales-comparison', subsection: 'comp5', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp5-rights-transferred', storeId: 'comp5-rights-transferred', label: 'Comp5 Rights Transferred', section: 'sales-comparison', subsection: 'comp5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp5-security-features', storeId: 'comp5-security-features', label: 'Comp5 Security Features', section: 'sales-comparison', subsection: 'comp5', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp5-transaction-status', storeId: 'comp5-transaction-status', label: 'Comp5 Transaction Status', section: 'sales-comparison', subsection: 'comp5', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'comp5-cap-rate', storeId: 'comp5-cap-rate', label: 'Comp5 Cap Rate', section: 'sales-comparison', subsection: 'comp5', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'comp5-parking-type', storeId: 'comp5-parking-type', label: 'Comp5 Parking Type', section: 'sales-comparison', subsection: 'comp5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp5-price-per-unit', storeId: 'comp5-price-per-unit', label: 'Comp5 Price Per Unit', section: 'sales-comparison', subsection: 'comp5', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp5-property-name', storeId: 'comp5-property-name', label: 'Comp5 Property Name', section: 'sales-comparison', subsection: 'comp5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp5-sale-date', storeId: 'comp5-sale-date', label: 'Comp5 Sale Date', section: 'sales-comparison', subsection: 'comp5', type: 'date', inputSource: 'user-input', required: false },
  { id: 'comp5-sale-price', storeId: 'comp5-sale-price', label: 'Comp5 Sale Price', section: 'sales-comparison', subsection: 'comp5', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'comp5-unit-amenities', storeId: 'comp5-unit-amenities', label: 'Comp5 Unit Amenities', section: 'sales-comparison', subsection: 'comp5', type: 'text', inputSource: 'user-input', required: false },
  { id: 'comp5-year-built', storeId: 'comp5-year-built', label: 'Comp5 Year Built', section: 'sales-comparison', subsection: 'comp5', type: 'number', inputSource: 'user-input', required: false },
  ...
  { id: 'subject-year-built', storeId: 'subject-year-built', label: 'Year Built', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'effective-date', storeId: 'effective-date', label: 'Effective Date', section: 'exec', subsection: 'property-identification', type: 'date', inputSource: 'user-input', required: false },
  { id: 'exposure-time', storeId: 'exposure-time', label: 'Exposure Time', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'hbu-conclusion-vacant', storeId: 'hbu-conclusion-vacant', label: 'HBU Conclusion Vacant', section: 'hbu', subsection: 'hbu-as-vacant', type: 'textarea', inputSource: 'user-input', required: false },
  { id: 'property-address', storeId: 'property-address', label: 'Property Address', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  { id: 'site-size', storeId: 'site-size', label: 'Site Size', section: 'exec', subsection: 'property-identification', type: 'number', inputSource: 'user-input', required: false },
  { id: 'subject-occupancy', storeId: 'subject-occupancy', label: 'Subject Occupancy', section: 'exec', subsection: 'property-identification', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'valuation-scenario', storeId: 'valuation-scenario', label: 'Valuation Scenario', section: 'exec', subsection: 'property-identification', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'appraiser-name-credentials', storeId: 'appraiser-name-credentials', label: 'Appraiser Name & Credentials', section: 'cover', subsection: 'appraiser-info', type: 'text', inputSource: 'calculated', required: false, calculationFormula: 'appraiser-name + ", " + appraiser-credentials' },
  { id: 'appraiser1-signature', storeId: 'appraiser1-signature', label: 'Appraiser 1 Signature', section: 'cover', subsection: 'appraiser-info', type: 'image', inputSource: 'user-input', required: false },

  // Cover - Optional Fields Subsection
  { id: 'market', storeId: 'market', label: 'Market', section: 'cover', subsection: 'optional-fields', type: 'text', inputSource: 'user-input', required: false },
  { id: 'submarket', storeId: 'submarket', label: 'Submarket', section: 'cover', subsection: 'optional-fields', type: 'text', inputSource: 'user-input', required: false },
  { id: 'appraiser2-name', storeId: 'appraiser2-name', label: 'Appraiser 2 Name', section: 'cover', subsection: 'optional-fields', type: 'text', inputSource: 'user-input', required: false },
  ...
  { id: 'report-values', storeId: 'report-values', label: 'Final Value Conclusion', section: 'report', subsection: 'report-info', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'report-valuescenario1', storeId: 'report-valuescenario1', label: 'Value Scenario 1', section: 'report', subsection: 'report-info', type: 'currency', inputSource: 'user-input', required: false },
  ...
  { id: 'rentalrevenue-1bed-contractrent', storeId: 'rentalrevenue-1bed-contractrent', label: '1BR Contract Rent', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-1bed-convvmkt', storeId: 'rentalrevenue-1bed-convvmkt', label: '1BR Contract vs Market', section: 'calc-output', subsection: 'rental-revenue', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-1bed-marketrent', storeId: 'rentalrevenue-1bed-marketrent', label: '1BR Market Rent', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-1bed-persf', storeId: 'rentalrevenue-1bed-persf', label: '1BR Per SF', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-1bed-perunit', storeId: 'rentalrevenue-1bed-perunit', label: '1BR Per Unit', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-1bed-peryear', storeId: 'rentalrevenue-1bed-peryear', label: '1BR Per Year', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-1bed-units', storeId: 'rentalrevenue-1bed-units', label: '1BR Units Count', section: 'calc-output', subsection: 'rental-revenue', type: 'number', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-2bed-contractrent', storeId: 'rentalrevenue-2bed-contractrent', label: '2BR Contract Rent', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-2bed-convvmkt', storeId: 'rentalrevenue-2bed-convvmkt', label: '2BR Contract vs Market', section: 'calc-output', subsection: 'rental-revenue', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-2bed-marketrent', storeId: 'rentalrevenue-2bed-marketrent', label: '2BR Market Rent', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-2bed-persf', storeId: 'rentalrevenue-2bed-persf', label: '2BR Per SF', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-2bed-perunit', storeId: 'rentalrevenue-2bed-perunit', label: '2BR Per Unit', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-2bed-peryear', storeId: 'rentalrevenue-2bed-peryear', label: '2BR Per Year', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-2bed-units', storeId: 'rentalrevenue-2bed-units', label: '2BR Units Count', section: 'calc-output', subsection: 'rental-revenue', type: 'number', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-total-contractrent', storeId: 'rentalrevenue-total-contractrent', label: 'Total Contract Rent', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-total-convvmkt', storeId: 'rentalrevenue-total-convvmkt', label: 'Total Contract vs Market', section: 'calc-output', subsection: 'rental-revenue', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-total-marketrent', storeId: 'rentalrevenue-total-marketrent', label: 'Total Market Rent', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-total-persf', storeId: 'rentalrevenue-total-persf', label: 'Total Per SF', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-total-perunit', storeId: 'rentalrevenue-total-perunit', label: 'Total Per Unit', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'rentalrevenue-total-peryear', storeId: 'rentalrevenue-total-peryear', label: 'Total Per Year', section: 'calc-output', subsection: 'rental-revenue', type: 'currency', inputSource: 'calculated', required: false },

  // ============================================================================
  // CONTRACT VS MARKET FIELDS (15 fields)
  // ============================================================================

  { id: 'contractvsmarket-1bed-actualrent', storeId: 'contractvsmarket-1bed-actualrent', label: '1BR Actual Rent', section: 'calc-output', subsection: 'contract-vs-market', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-1bed-askingrent', storeId: 'contractvsmarket-1bed-askingrent', label: '1BR Asking Rent', section: 'calc-output', subsection: 'contract-vs-market', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-1bed-concludedrent', storeId: 'contractvsmarket-1bed-concludedrent', label: '1BR Concluded Rent', section: 'calc-output', subsection: 'contract-vs-market', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-1bed-percentage', storeId: 'contractvsmarket-1bed-percentage', label: '1BR Percentage', section: 'calc-output', subsection: 'contract-vs-market', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-1bed-units', storeId: 'contractvsmarket-1bed-units', label: '1BR Units', section: 'calc-output', subsection: 'contract-vs-market', type: 'number', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-2bed-actualrent', storeId: 'contractvsmarket-2bed-actualrent', label: '2BR Actual Rent', section: 'calc-output', subsection: 'contract-vs-market', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-2bed-askingrent', storeId: 'contractvsmarket-2bed-askingrent', label: '2BR Asking Rent', section: 'calc-output', subsection: 'contract-vs-market', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-2bed-concludedrent', storeId: 'contractvsmarket-2bed-concludedrent', label: '2BR Concluded Rent', section: 'calc-output', subsection: 'contract-vs-market', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-2bed-percentage', storeId: 'contractvsmarket-2bed-percentage', label: '2BR Percentage', section: 'calc-output', subsection: 'contract-vs-market', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-2bed-units', storeId: 'contractvsmarket-2bed-units', label: '2BR Units', section: 'calc-output', subsection: 'contract-vs-market', type: 'number', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-total-actualrent', storeId: 'contractvsmarket-total-actualrent', label: 'Total Actual Rent', section: 'calc-output', subsection: 'contract-vs-market', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-total-askingrent', storeId: 'contractvsmarket-total-askingrent', label: 'Total Asking Rent', section: 'calc-output', subsection: 'contract-vs-market', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-total-concludedrent', storeId: 'contractvsmarket-total-concludedrent', label: 'Total Concluded Rent', section: 'calc-output', subsection: 'contract-vs-market', type: 'currency', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-total-percentage', storeId: 'contractvsmarket-total-percentage', label: 'Total Percentage', section: 'calc-output', subsection: 'contract-vs-market', type: 'percentage', inputSource: 'calculated', required: false },
  { id: 'contractvsmarket-total-units', storeId: 'contractvsmarket-total-units', label: 'Total Units', section: 'calc-output', subsection: 'contract-vs-market', type: 'number', inputSource: 'calculated', required: false },

  // ============================================================================
  // OTHER REVENUE FIELDS (11 fields)
  // ============================================================================

  { id: 'otherrevenue-laundry-percent', storeId: 'otherrevenue-laundry-percent', label: 'Laundry Revenue Percent', section: 'calc-output', subsection: 'other-revenue', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-laundry-persf', storeId: 'otherrevenue-laundry-persf', label: 'Laundry Revenue Per SF', section: 'calc-output', subsection: 'other-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-laundry-perunit', storeId: 'otherrevenue-laundry-perunit', label: 'Laundry Revenue Per Unit', section: 'calc-output', subsection: 'other-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-laundry-total', storeId: 'otherrevenue-laundry-total', label: 'Laundry Revenue Total', section: 'calc-output', subsection: 'other-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-parking-percent', storeId: 'otherrevenue-parking-percent', label: 'Parking Revenue Percent', section: 'calc-output', subsection: 'other-revenue', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-parking-persf', storeId: 'otherrevenue-parking-persf', label: 'Parking Revenue Per SF', section: 'calc-output', subsection: 'other-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-parking-perunit', storeId: 'otherrevenue-parking-perunit', label: 'Parking Revenue Per Unit', section: 'calc-output', subsection: 'other-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-parking-total', storeId: 'otherrevenue-parking-total', label: 'Parking Revenue Total', section: 'calc-output', subsection: 'other-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-total-persf', storeId: 'otherrevenue-total-persf', label: 'Other Revenue Total Per SF', section: 'calc-output', subsection: 'other-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-total-perunit', storeId: 'otherrevenue-total-perunit', label: 'Other Revenue Total Per Unit', section: 'calc-output', subsection: 'other-revenue', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'otherrevenue-total-total', storeId: 'otherrevenue-total-total', label: 'Other Revenue Grand Total', section: 'calc-output', subsection: 'other-revenue', type: 'currency', inputSource: 'user-input', required: false },
  ...
  { id: 'revenue-laundry-proj-pct', storeId: 'revenue-laundry-proj-pct', label: 'Laundry Revenue - Projected %', section: 'calc-output', subsection: 'revenue-projections', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'revenue-laundry-proj-total', storeId: 'revenue-laundry-proj-total', label: 'Laundry Revenue - Projected Total', section: 'calc-output', subsection: 'revenue-projections', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'revenue-misc-proj-pct', storeId: 'revenue-misc-proj-pct', label: 'Misc Revenue - Projected %', section: 'calc-output', subsection: 'revenue-projections', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'revenue-multifamily-proj-pct', storeId: 'revenue-multifamily-proj-pct', label: 'Multifamily Revenue - Projected %', section: 'calc-output', subsection: 'revenue-projections', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'revenue-parking-proj-pct', storeId: 'revenue-parking-proj-pct', label: 'Parking Revenue - Projected %', section: 'calc-output', subsection: 'revenue-projections', type: 'percentage', inputSource: 'user-input', required: false },
  { id: 'revenue-rental-proj-pct', storeId: 'revenue-rental-proj-pct', label: 'Rental Revenue - Projected %', section: 'calc-output', subsection: 'revenue-projections', type: 'percentage', inputSource: 'user-input', required: false },

  // ============================================================================
  // VACANCY & CREDIT LOSS FIELDS (4 fields)
  // ============================================================================

  { id: 'vacancy-loss-sf', storeId: 'vacancy-loss-sf', label: 'Vacancy Loss Per SF', section: 'calc-output', subsection: 'vacancy-loss', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'vacancy-loss-unit', storeId: 'vacancy-loss-unit', label: 'Vacancy Loss Per Unit', section: 'calc-output', subsection: 'vacancy-loss', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'vacancy-loss-year', storeId: 'vacancy-loss-year', label: 'Vacancy Loss Per Year', section: 'calc-output', subsection: 'vacancy-loss', type: 'currency', inputSource: 'user-input', required: false },
  { id: 'vacancy-rate-concluded', storeId: 'vacancy-rate-concluded', label: 'Vacancy Rate - Concluded', section: 'calc-output', subsection: 'vacancy-loss', type: 'percentage', inputSource: 'user-input', required: false },
