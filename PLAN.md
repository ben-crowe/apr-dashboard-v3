...
Single source of truth for the project's roadmap, to-dos, and next steps. Historical plans are in `Plan-vario0us/`.
...
3. **Data Bridge** — Pull job\_submissions + job\_loe\_details into Report Builder "Home" section automatically.
