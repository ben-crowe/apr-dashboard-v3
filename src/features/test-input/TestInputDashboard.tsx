...
const TestInputDashboard: React.FC = () => {
  ...
  const [expandedImageDestinations, setExpandedImageDestinations] = useState<
    Set<string>
  >(new Set());
  const [expandedCalcSubsections, setExpandedCalcSubsections] = useState<
    Set<string>
  >(new Set());
  const [expandedPhotoSubsections, setExpandedPhotoSubsections] = useState<
    Set<string>
  >(new Set());
  const [expandedAllCalcOutputSections, setExpandedAllCalcOutputSections] =
  ...
  useEffect(() => {
    const initStore = async () => {
      ...
      console.log(
        "TestInputDashboard: Ready - press a button to load test data",
      );
    };
    initStore();
  ...
  const legacyClientFields: Record<
    string,
    {
  ...
  > = {
    ...
    "client-city": {
      managedFieldId: "client-city",
      destination: "S1 - Client Intake",
      section: "client-intake",
      subsection: "client-info-intake",
    },
    "client-province": {
      managedFieldId: "client-province",
      destination: "S1 - Client Intake",
      section: "client-intake",
      subsection: "client-info-intake",
    },
    "client-postal": {
      managedFieldId: "client-postal",
      destination: "S1 - Client Intake",
      section: "client-intake",
      subsection: "client-info-intake",
    },
    "client-title": {
      managedFieldId: "client-title",
      destination: "S1 - Client Intake",
      section: "client-intake",
      subsection: "client-info-intake",
    },
  ...
  const legacyAppraiserFields: Record<
    string,
    {
      managedFieldId: string;
      destination: string;
  ...
  > = {
    ...
    "appraiser-name": {
      managedFieldId: "appraiser-name",
      destination: "S2 - LOE Prep",
      section: "loe-prep",
      subsection: "appraiser-info",
    },
    "appraiser-credentials": {
      managedFieldId: "appraiser-credentials",
      destination: "S2 - LOE Prep",
      section: "loe-prep",
      subsection: "appraiser-info",
    },
    "appraiser-title": {
      managedFieldId: "appraiser-title",
      destination: "S2 - LOE Prep",
      section: "loe-prep",
      subsection: "appraiser-info",
    },
    "appraiser-email": {
      managedFieldId: "appraiser-email",
      destination: "S2 - LOE Prep",
      section: "loe-prep",
      subsection: "appraiser-info",
    },
    "appraiser-aic": {
      managedFieldId: "appraiser-aic",
      destination: "S2 - LOE Prep",
      section: "loe-prep",
      subsection: "appraiser-info",
    },
    "valuation-date": {
      managedFieldId: "valuation-date",
      destination: "S2 - LOE Prep",
      section: "loe-prep",
      subsection: "appraiser-info",
    },
    "report-date": {
      managedFieldId: "report-date",
      destination: "S2 - LOE Prep",
      section: "loe-prep",
      subsection: "appraiser-info",
    },
  ...
  const legacyImageFields: Record<
    string,
    {
      managedFieldId: string;
      destination: string;
  ...
  > = {
    // Cover Section
    "cover-photo": {
      managedFieldId: "img-cover-photo",
      destination: "01 - Cover & Signature",
      section: "image-mgt",
      subsection: "cover-images",
    },
    "appraiser1-signature": {
      managedFieldId: "img-signature",
      destination: "01 - Cover & Signature",
      section: "image-mgt",
      subsection: "cover-images",
    },
    ...
    "photos-exterior": {
      managedFieldId: "img-exterior-1",
      destination: "07 - Property Photographs",
      section: "image-mgt",
      subsection: "exterior-photos",
    },
    "photos-street": {
      managedFieldId: "img-street-1",
      destination: "07 - Property Photographs",
      section: "image-mgt",
      subsection: "street-photos",
    },
    "photos-common": {
      managedFieldId: "img-common-1",
      destination: "07 - Property Photographs",
      section: "image-mgt",
      subsection: "common-photos",
    },
    "photos-units": {
      managedFieldId: "img-unit-1",
      destination: "07 - Property Photographs",
      section: "image-mgt",
      subsection: "unit-photos",
    },
    "photos-systems": {
      managedFieldId: "img-systems-1",
      destination: "07 - Property Photographs",
      section: "image-mgt",
    ...
    // Site Section
    "site-plan-image": {
      managedFieldId: "img-site-plan-1",
      destination: "03 - Location Maps",
      section: "image-mgt",
      subsection: "maps",
    },
    ...
    "comp1-map": {
      managedFieldId: "comp1-map",
      destination: "10 - Sales Comp Maps",
      section: "image-mgt",
      subsection: "comp-maps",
    },
    "comp2-map": {
      managedFieldId: "comp2-map",
      destination: "10 - Sales Comp Maps",
      section: "image-mgt",
      subsection: "comp-maps",
    },
    "comp3-map": {
      managedFieldId: "comp3-map",
      destination: "10 - Sales Comp Maps",
      section: "image-mgt",
      subsection: "comp-maps",
    },
    "comp4-map": {
      managedFieldId: "comp4-map",
      destination: "10 - Sales Comp Maps",
      section: "image-mgt",
      subsection: "comp-maps",
    },
    "comp5-map": {
      managedFieldId: "comp5-map",
      destination: "10 - Sales Comp Maps",
      section: "image-mgt",
      subsection: "comp-maps",
    },
    ...
    "comp1-photo": {
      managedFieldId: "comp1-photo",
      destination: "09 - Sales Comp Photos",
      section: "image-mgt",
      subsection: "comp-photos",
    },
    "comp2-photo": {
      managedFieldId: "comp2-photo",
      destination: "09 - Sales Comp Photos",
      section: "image-mgt",
      subsection: "comp-photos",
    },
    "comp3-photo": {
      managedFieldId: "comp3-photo",
      destination: "09 - Sales Comp Photos",
      section: "image-mgt",
      subsection: "comp-photos",
    },
    "comp4-photo": {
      managedFieldId: "comp4-photo",
      destination: "09 - Sales Comp Photos",
      section: "image-mgt",
      subsection: "comp-photos",
    },
    "comp5-photo": {
      managedFieldId: "comp5-photo",
      destination: "09 - Sales Comp Photos",
      section: "image-mgt",
      subsection: "comp-photos",
    },
    ...
    "rental-comparables-map": {
      managedFieldId: "rental-comparables-map",
      destination: "11 - Rental Comp Photos",
      section: "image-mgt",
  ...
  const categorizeValuationFields = (
  ...
  const stats = useMemo(() => {
    ...
    sections.forEach((section) => {
      section.fields?.forEach((field) =>
        storeValues.set(field.id, field.value),
      );
  ...
  useEffect(() => {
    console.log(
      `Test Data Dashboard: ${stats.mapped}/${stats.total} fields mapped (${stats.percentage}%)`,
    );
  }, [stats]);
  ...
  const groupImageFieldsWithCaptions = (
    fields: FieldDefinition[],
  ): Array<{ image: FieldDefinition; caption?: FieldDefinition }> => {
    const imageFields = fields.filter((f) => f.type === "image");
    const captionFields = fields.filter(
      (f) => f.type === "text" && f.id.endsWith("-caption"),
    );
    ...
    switch (field.type) {
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                ...
                <span className="text-slate-500">
                  {appraiserDateMapping.destination}
                </span>
              </button>
            </div>
          );
      ...
      case "image":
        ...
        if (legacyMapping) {
          ...
          const destinationId =
            imageDestinationMap[legacyMapping.subsection] || "cover-sig";
          ...
          return (
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => {
                  setExpandedSections(
                    (prev) => new Set([...prev, "image-mgt"]),
                  );
                  setExpandedImageDestinations(
                    (prev) => new Set([...prev, destinationId]),
                  );
                  setTimeout(() => {
                    const element =
                      document.getElementById("section-image-mgt");
                    element?.scrollIntoView({
                      behavior: "smooth",
                      block: "start",
                    });
          ...
          return (
            <div className="flex flex-col gap-1">
              ...
              <button
                onClick={() => {
                  setExpandedSections(
                    (prev) => new Set([...prev, "client-intake"]),
                  );
                  setTimeout(() => {
          ...
          return (
            <div className="flex flex-col gap-1">
              ...
              >
                <span className="font-medium">Managed in S2</span>
                <span className="text-slate-500">
                  {appraiserTextMapping.destination}
                </span>
              </button>
            </div>
          );
  ...
  const renderStatusBadge = (status: FieldStatus) => {
    switch (status) {
      case "mapped":
        return (
          <Badge className="bg-green-500 text-white text-xs">Mapped</Badge>
        );
      case "empty":
        return (
          <Badge className="bg-yellow-500 text-white text-xs">Empty</Badge>
        );
      case "missing":
  ...
  const allCalculatedFields = useMemo(() => {
    const calcFields = fieldRegistry.filter(
      (f) => f.inputSource === "calculated",
    );
          ...
          >
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                style={{
                  backgroundColor:
                    selectedDataset !== null ? "#22c55e" : "#1f1f1f",
          ...
          {allSections
            ...
            .map((sectionId) => {
              const allFields = getFieldsBySection(sectionId)
                ...
                .filter(
                  (f) => !datasetFieldIds || datasetFieldIds.has(f.storeId),
                );
              ...
              const mappedFields = fields.filter(
                (f) => getFieldStatus(f).status === "mapped",
              );
              ...
              const sectionName =
                sectionNameMapping[sectionId] || sectionId.toUpperCase();
                        ...
                        {sectionId === "calc" ? (
                          ...
                          >
                            ...
                            <Collapsible
                              ...
                              onOpenChange={() =>
                                toggleCalcSubsection("inputs-main")
                              }
                            >
                              <div
                              ...
                              >
                                <CollapsibleTrigger className="w-full">
                                  <div
                                    className="px-4 py-3 flex items-center justify-between cursor-pointer transition-colors hover:bg-[#333333]"
                                    style={{ backgroundColor: "#2a2a2a" }}
                                  >
                                    <div className="flex items-center gap-2">
                                      {expandedCalcSubsections.has(
                                        "inputs-main",
                                      ) ? (
                                        <ChevronDown
                                          className="w-5 h-5"
                                    ...
                                    {[
                                      ...
                                      const subsectionFields =
                                        getFieldsBySubsection(
                                          ...
                                          .filter(
                                            (f) =>
                                              f.inputSource === "user-input",
                                          )
                                          .filter(
                                            (f) =>
                                              !datasetFieldIds ||
                                              datasetFieldIds.has(f.storeId),
                                          );
                                      ...
                                      return (
                                        <Collapsible
                                          key={subsectionId}
                                          open={expandedCalcSubsections.has(
                                            subsectionId,
                                          )}
                                          onOpenChange={() =>
                                            toggleCalcSubsection(subsectionId)
                                          }
                                        >
                                          <div
                                          ...
                                          >
                                            <CollapsibleTrigger className="w-full">
                                              <div
                                                className="px-4 py-2 flex items-center justify-between cursor-pointer transition-colors hover:bg-[#333333]"
                                                style={{
                                                  backgroundColor: "#2a2a2a",
                                                }}
                                              >
                                                    ...
                                                    {subsectionFields.map(
                                                      (field) => {
                                                        ...
                                                        return (
                                                          <tr
                                                            key={field.id}
                                                            className="border-b hover:bg-[#333333]"
                                                            style={{
                                                              borderColor:
                                                                "#4b5563",
                                                            }}
                                                          >
                                                            <td
                                                              className="px-2 py-1.5 text-xs font-mono w-48"
                                                              style={{
                                                                color:
                                                                  "#9ca3af",
                                                              }}
                            ...
                            <Collapsible
                              ...
                              onOpenChange={() =>
                                toggleCalcSubsection("outputs-main")
                              }
                            >
                              <div
                                className="border-2 rounded-lg overflow-hidden"
                                ...
                                <CollapsibleContent>
                                  ...
                                  >
                                    ...
                                    {(() => {
                                      ...
                                      const outputGroups: Record<
                                        string,
                                        { label: string; sections: string[] }
                                      > = {
                                        "income-approach": {
                                          label:
                                            "Income Approach (PGR, EGR, NOI, Cap Value)",
                                          sections: [
                                            "calc",
                                            "calc-output",
                                            "calc-unit-mix",
                                        ...
                                        other: {
                                          ...
                                          sections: [
                                            ...
                                            "client-info-intake",
                                            "client-info",
                                            "property-contact-intake",
                                            "appraiser-info",
                                          ],
                                        },
                                      };

                                      return Object.entries(outputGroups).map(
                                        ([
                                          groupId,
                                          { label, sections: groupSections },
                                        ]) => {
                                          ...
                                          return (
                                            <Collapsible
                                              key={groupId}
                                              open={expandedAllCalcOutputSections.has(
                                                groupId,
                                              )}
                                              onOpenChange={() =>
                                                toggleAllCalcOutputSection(
                                                  groupId,
                                                )
                                              }
                                            >
                                              ...
                                              >
                                                <CollapsibleTrigger className="w-full">
                                                  ...
                                                  >
                                                    <div className="flex items-center gap-2">
                                                      {expandedAllCalcOutputSections.has(
                                                        groupId,
                                                      ) ? (
                                                        <ChevronDown
                                                          className="w-4 h-4"
                          ...
                          >
                            ...
                            <Collapsible
                              ...
                              onOpenChange={() =>
                                toggleImageDestination("cover-sig")
                              }
                            >
                              <div
                                className="border rounded-lg overflow-hidden"
                              ...
                              >
                                <CollapsibleTrigger className="w-full">
                                  ...
                                  >
                                    ...
                                    <Badge
                                      variant="outline"
                                      className="text-xs ml-auto text-gray-300 border-gray-500"
                                    >
                                      {
                                        getFieldsBySubsection(
                                          sectionId,
                            ...
                            {/* 03 - Location Maps */}
                            <Collapsible
                              open={expandedImageDestinations.has(
                                "location-maps",
                              )}
                              onOpenChange={() =>
                                toggleImageDestination("location-maps")
                              }
                            >
                              <div
                                className="border rounded-lg overflow-hidden"
                              ...
                              >
                                ...
                                <CollapsibleContent>
                                  ...
                                  >
                                    <div className="grid grid-cols-2 gap-4">
                                      {getFieldsBySubsection(sectionId, "maps")
                                        .filter(
                                          (f) => f.inputSource === "user-input",
                                        )
                                        .map((field) => {
                            ...
                            <Collapsible
                              ...
                              onOpenChange={() =>
                                toggleImageDestination("property-photos")
                              }
                            >
                              <div
                                className="border rounded-lg overflow-hidden"
                              ...
                              >
                                ...
                                <CollapsibleContent>
                                  ...
                                  >
                                    {/* Exterior Photos */}
                                    <Collapsible
                                      open={expandedPhotoSubsections.has(
                                        "exterior-photos",
                                      )}
                                      onOpenChange={() =>
                                        togglePhotoSubsection("exterior-photos")
                                      }
                                    >
                                      <div
                                        className="border rounded-lg overflow-hidden"
                                    ...
                                    <Collapsible
                                      ...
                                      onOpenChange={() =>
                                        togglePhotoSubsection("street-photos")
                                      }
                                    >
                                      <div
                                        className="border rounded-lg overflow-hidden"
                                    ...
                                    <Collapsible
                                      ...
                                      onOpenChange={() =>
                                        togglePhotoSubsection("common-photos")
                                      }
                                    >
                                      <div
                                        className="border rounded-lg overflow-hidden"
                                    ...
                                    <Collapsible
                                      ...
                                      onOpenChange={() =>
                                        togglePhotoSubsection("unit-photos")
                                      }
                                    >
                                      <div
                                        className="border rounded-lg overflow-hidden"
                                    ...
                                    <Collapsible
                                      ...
                                      onOpenChange={() =>
                                        togglePhotoSubsection("systems-photos")
                                      }
                                    >
                                      <div
                                        className="border rounded-lg overflow-hidden"
                            ...
                            <Collapsible
                              ...
                              onOpenChange={() =>
                                toggleImageDestination("subject-photos")
                              }
                            >
                              <div
                                className="border rounded-lg overflow-hidden"
                                  ...
                                  >
                                    <div className="grid grid-cols-2 gap-4">
                                      {groupImageFieldsWithCaptions(
                                        ...
                                        const imageStatus =
                                          getFieldStatus(image);
                                        const captionStatus = caption
                                          ? getFieldStatus(caption)
                                          : null;
                                        return (
                                          <div
                                            key={image.id}
                            ...
                            <Collapsible
                              ...
                              onOpenChange={() =>
                                toggleImageDestination("comp-photos")
                              }
                            >
                              <div
                                className="border rounded-lg overflow-hidden"
                            ...
                            <Collapsible
                              ...
                              onOpenChange={() =>
                                toggleImageDestination("comp-maps")
                              }
                            >
                              <div
                                className="border rounded-lg overflow-hidden"
                            ...
                            <Collapsible
                              ...
                              onOpenChange={() =>
                                toggleImageDestination("rental-comp-photos")
                              }
                            >
                              <div
                                className="border rounded-lg overflow-hidden"
                                  ...
                                  >
                                    <div className="grid grid-cols-2 gap-4">
                                      ...
                                      {(() => {
                                        ...
                                        if (rentalMapField) {
                                          const statusInfo =
                                            getFieldStatus(rentalMapField);
                                          return (
                                            <div
                                              key={rentalMapField.id}
                                              className="flex flex-col gap-1"
                                            >
                                              <label
                                                className="text-xs font-medium"
                          ...
                          >
                            <table className="w-full">
                              <thead>
                                ...
                                >
                                  <th
                                    className="text-left text-xs font-semibold px-4 py-2 w-48"
                                    style={{ color: "#9ca3af" }}
                                  >
                                    Field ID
                                  </th>
                                  ...
                                  <th
                                    className="text-left text-xs font-semibold px-4 py-2 w-24"
                                    style={{ color: "#9ca3af" }}
                                  >
                                    Status
                                  </th>
