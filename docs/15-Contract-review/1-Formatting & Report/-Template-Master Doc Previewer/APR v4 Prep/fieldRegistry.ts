...
export const fieldRegistry: FieldDefinition[] = [
  ...
  { id: 'effective-date', storeId: 'effective-date', label: 'Effective Date (Valuation)', section: 'cover', type: 'date', inputSource: 'calculated', required: true, notes: 'Alias for valuation-date for HTML template' },

  // Cover - Subject Property Info (for HTML template)
  { id: 'subject-photo', storeId: 'subject-photo', label: 'Subject Photo', section: 'cover', subsection: 'subject-info', type: 'image', inputSource: 'user-input', required: false },
  { id: 'subject-primary', storeId: 'subject-primary', label: 'Primary Property Type', section: 'cover', subsection: 'subject-info', type: 'text', inputSource: 'user-input', required: true },
  { id: 'subject-subtype', storeId: 'subject-subtype', label: 'Property Subtype', section: 'cover', subsection: 'subject-info', type: 'text', inputSource: 'user-input', required: false },
  { id: 'subject-property-name', storeId: 'subject-property-name', label: 'Property Name', section: 'cover', subsection: 'subject-info', type: 'text', inputSource: 'calculated', required: true, notes: 'Alias for property-name' },
  { id: 'subject-street', storeId: 'subject-street', label: 'Street Address', section: 'cover', subsection: 'subject-info', type: 'text', inputSource: 'calculated', required: true, notes: 'Alias for street-address' },
  { id: 'subject-city', storeId: 'subject-city', label: 'City', section: 'cover', subsection: 'subject-info', type: 'text', inputSource: 'calculated', required: true, notes: 'Alias for city' },
  { id: 'subject-state', storeId: 'subject-state', label: 'Province/State', section: 'cover', subsection: 'subject-info', type: 'text', inputSource: 'calculated', required: true, notes: 'Alias for province' },
  ...
  { id: 'client-citystatezip', storeId: 'client-citystatezip', label: 'Client City/Province/Postal', section: 'cover', subsection: 'client-info', type: 'text', inputSource: 'calculated', required: false, notes: 'Combined from client-city, client-province, client-postal' },
  ...
  // Cover - Company Info Aliases (for HTML template - populated from appraiser- fields)
  { id: 'company-name', storeId: 'company-name', label: 'Company Name', section: 'cover', subsection: 'company-info', type: 'text', inputSource: 'calculated', required: true, notes: 'Alias for appraiser-company' },
  { id: 'company-address', storeId: 'company-address', label: 'Company Address', section: 'cover', subsection: 'company-info', type: 'text', inputSource: 'calculated', required: false, notes: 'Alias for appraiser-address' },
  { id: 'company-citystatezip', storeId: 'company-citystatezip', label: 'Company City/Province/Postal', section: 'cover', subsection: 'company-info', type: 'text', inputSource: 'calculated', required: false, notes: 'Combined from appraiser-city, appraiser-province, appraiser-postal' },
  { id: 'company-phone', storeId: 'company-phone', label: 'Company Phone', section: 'cover', subsection: 'company-info', type: 'text', inputSource: 'calculated', required: false, notes: 'Alias for appraiser-phone' },
  { id: 'company-website', storeId: 'company-website', label: 'Company Website', section: 'cover', subsection: 'company-info', type: 'text', inputSource: 'calculated', required: false, notes: 'Alias for appraiser-website' },
