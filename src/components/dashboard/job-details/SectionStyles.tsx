...
export const sectionTitleStyle = "text-base font-semibold text-foreground";
export const sectionTriggerStyle = "hover:no-underline py-4";
export const sectionContentStyle = "pt-1 pb-6";
export const sectionContentWrapperStyle = "bg-muted rounded-lg p-4 space-y-6";

// Consistent subheading style for all sections
export const subheadingStyle = "text-sm font-semibold text-foreground mb-3 pb-2 border-b border-border";

// Field group container style
export const fieldGroupStyle = "bg-card rounded-md p-4 border border-border";
