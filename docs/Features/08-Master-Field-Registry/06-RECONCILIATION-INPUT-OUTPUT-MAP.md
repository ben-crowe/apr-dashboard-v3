...
**Value Indications**:
- `calc-indicated-value` ← Calculated from Income Approach (Doc 03)
- `sca-indicated-value` ← Calculated from Sales Comparison (Doc 04)
- `cost-indicated-value` ← Calculated from Cost Approach (Doc 05)
