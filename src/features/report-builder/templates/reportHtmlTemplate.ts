...
export function generateReportHtml(sections: ReportSection[]): string {
  // DEBUG: Verify logo constant is accessible
  console.log("🖼️ VALTA_LOGO_BASE64 length:", VALTA_LOGO_BASE64.length);
  console.log("🖼️ Logo starts with:", VALTA_LOGO_BASE64.substring(0, 50));
  ...
  <style>
    * {
    ...
    .cover-page {
      ...
      min-height: 11in;
      overflow: hidden;
      padding: 0;  /* Override inherited padding from .page - cover is edge-to-edge */
      background: white;
    ...
    @page {
      size: 8.5in 11in;
      margin: 0; /* CRITICAL: We handle margins inside .page elements for full layout control */
    }
    ...
    @media print {
      ...
      .cover-page {
        page-break-after: always;
        padding: 0;  /* Cover is edge-to-edge, no padding */
      }
...
<body>
  ...
  <!-- Letter of Transmittal - Page 3 (Page 1 of Letter) -->
  <div id="section-home-page-1" class="page letter-page">
  ...
  <!-- Letter of Transmittal - Page 4 (Page 2 of Letter) -->
  <div id="section-home-page-2" class="page letter-page">
    <div class="page-number"></div>
    <div class="letter-header">
      <img src="${VALTA_LOGO_BASE64}" alt="${appraiserCompany}" class="letter-logo" />
      <div class="letter-company-address">
    ...
    <div class="letter-body" style="margin-top: 3rem;">
      ...
      <div class="letter-signature-block">
        ${appraiserSignature ? `<img src="${appraiserSignature}" alt="Appraiser Signature" style="width: 200px; height: auto; margin-bottom: 0.5rem;" />` : '<div class="letter-signature-line"></div>'}
